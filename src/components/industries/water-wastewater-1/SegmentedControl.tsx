 ...
 * pressed-button semantics — an independent on/off state per item. Every use on
 * this page is genuinely one-of-N (which system, which view, which scenario,
 * which control). `OXOT_Layout_Styles.md`'s Case File Index entry settles this
 * exact question in the opposite direction for its own multi-select chips:
 * match the ARIA role to what the control actually is rather than reaching for
 * whichever component is nearest. This is the one-of-N half of that same rule.
