 ...
 * own closing panel: the source brief's final-CTA copy is distinct,
 * page-tailored persuasion worth more than the generic three-door choice
 * alone.
 */
export function HyperscaleFinalCta({ locale }: { locale: Locale }) {
  const t = FINAL_CTA;
  /* /technical-specification is EN-only — NL falls back to /cdt-2, same
     no-404 reasoning as EnergyRegulatory/EnergyFinalCta. */
