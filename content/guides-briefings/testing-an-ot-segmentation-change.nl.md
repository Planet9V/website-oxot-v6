...
---
**Deze Guide is nog niet vertaald.** De Engelse versie staat hieronder. *(This Guide has not yet been translated — the English version follows.)*
...
If you want the short-form version of this argument rather than the method, [Can we change this safely?](/nl/decisions/change-safely) states it in a page, with the before-and-after route comparison drawn out.
...
Read the short-form version of the argument at [Can we change this safely?](/nl/decisions/change-safely), then bring us the change. We will show you what the baseline reading looks like on your own evidence, and what the route-state table says once the control is inserted.
