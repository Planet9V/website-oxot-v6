...
The fuller technical treatment — the three boundary diagrams, the import workflow, the intelligence-update options and the governance requirement list — is on [Deployment & Data Sovereignty](/en/deployment-sovereignty). Take that to your security authority.
