...
export function buildCampus(THREE) {
  ...
  }
  {
    ...
    pipe('PWR_rpp_riser', M.pwr_busway, 0.07, [[-14.2, 2.0, 1.5], [-14.2, 3.6, 1.5], [-6.3, 3.6, 1.5]], g);
    cyl('PWR_hall_busway_spine', M.pwr_busway, 0.07, 19.5, -6.3, 3.6, 0.25, 'z', g);
  ...
  // ===== internet demarcation + external cloud ==========================
  {
    ...
    // internet / cloud, drawn outside the perimeter as an external boundary
    box('DATA_internet_cloud', M.glass, 6.0, 2.6, 3.0, 0, 9.5, -26, g);
    box('DATA_internet_cloud_label', M.white_box, 2.4, 0.5, 0.06, 0, 9.5, -24.45, g);
...
function buildGraph(THREE, root) {
  ...
  N('busway','Hall busway spine','Busway / bus duct','PWR','Data hall','PWR_hall_busway_spine',
    { zone:'Z3', purdue:'L0', slt:'SL-T 1', vendor:'Starline / Eaton Pow-R-Way III',
  ...
  N('row1_busway','Row 01 busway','Busway','PWR','Data hall','PWR_row01_busway',
    { zone:'Z3', purdue:'L0', slt:'SL-T 1', vendor:'Starline Track Busway' });
  ...
  N('chiller','Chiller 30XW','Water-cooled centrifugal chiller','CHW','Chiller room','CHW_chiller_carrier_30xw',
    { zone:'Z2', purdue:'L2', slt:'SL-T 2-3', vendor:'Carrier AquaEdge 30XW', standards:'IEC 62443, ASHRAE 15',
      ...
      surface:['OEM cloud diagnostics is a Z2 \u2192 external conduit and must transit the Z1 DMZ.',
               'Plant compromise causes thermal shutdown of the IT load — treat as safety-adjacent.'] });
  N('chiller_b','Chiller CenTraVac','Water-cooled chiller','CHW','Chiller room','CHW_chiller_trane_cvhf',
    { zone:'Z2', purdue:'L2', slt:'SL-T 2-3', vendor:'Trane CenTraVac' });
  N('chiller_c','Chiller YZ magnetic-bearing','Water-cooled chiller','CHW','Chiller room','CHW_chiller_york_yz',
    { zone:'Z2', purdue:'L2', slt:'SL-T 2-3', vendor:'York / JCI YZ', attrs:{ efficiency:'COP 6-8 at part load' } });
  N('chiller_ctl','Chiller plant controller','Unit controller','BMS','Chiller room','BMS_chiller_carrier_30xw_optiview',
  ...
  N('pump','Primary CHW pump 1','Centrifugal pump','CHW','Chiller room','CHW_pump_grundfos_0',
    { zone:'Z3', purdue:'L0', slt:'SL-T 1', vendor:'Grundfos', standards:'ASHRAE TC 9.9' });
  N('pump_b','Primary CHW pump 2','Centrifugal pump','CHW','Chiller room','CHW_pump_grundfos_1',
    { zone:'Z3', purdue:'L0', slt:'SL-T 1', vendor:'Grundfos', attrs:{ role:'N+1' } });
  N('vfd','Pump VFD ACQ580','Variable frequency drive','CHW','Chiller room','CHW_vfd_abb_acq580_0',
  ...
  N('vfd_b','Pump VFD 2','Variable frequency drive','CHW','Chiller room','CHW_vfd_abb_acq580_1',
    { zone:'Z2', purdue:'L1-L2', slt:'SL-T 2', vendor:'ABB ACQ580' });
  N('wts_plc','Water treatment PLC','PLC','BMS','Chiller room','BMS_wts_plc_s71200',
  ...
  N('row1_cdu','Row 01 CDU','Coolant distribution unit','CHW','Data hall','row01_cdu_rack',
    { zone:'Z2', purdue:'L2', slt:'SL-T 2-3', vendor:'Motivair / CoolIT / Vertiv XDU',
      standards:'OCP Liquid Cooling Spec, ASHRAE TC 9.9',
      attrs:{ pumps:'2 (N+1)', loops:'TCS secondary \u2194 FWS primary', density:'mandatory \u2265 50 kW/rack' },
      surface:['CDU vendor cloud portal is a Z2 \u2192 external conduit.',
               'Manipulating flow or temperature setpoints causes thermal runaway in ~90 s at full load.',
               'Firmware checks on CDUs are a high-value assurance target for AI halls.'] });
  N('row1_cdu_plc','Row 01 CDU controller','PLC','BMS','Data hall','BMS_row01_cdu_rack_plc',
    { zone:'Z2', purdue:'L1-L2', slt:'SL-T 3', vendor:'Siemens / Schneider', standards:'IEC 62443-4-2',
      surface:['Direct cyber-physical authority over pumps and valves for a 130 kW+ row.'] });
  N('row1_tcs','Row 01 TCS header','Technology cooling header','CHW','Data hall','CHW_row01_tcs_header_supply',
    { zone:'Z3', purdue:'L0', slt:'SL-T 1', standards:'OCP Liquid Cooling Spec',
      attrs:{ loop:'technology cooling system (secondary)' } });
  N('row1_rack1','Row 01 rack 01','GPU rack (48U, D2C liquid)','IT','Data hall','row01_rack01',
    { zone:'Z0', purdue:'L4-L5', slt:'SL-T 2', standards:'OCP S.A.F.E.',
      attrs:{ load:'~120 kW', cooling:'direct-to-chip cold plates' } });
  ...
  N('row1_leak','Row 01 leak detection','TDR sensing cable','BMS','Data hall','BMS_row01_leak_ring',
    { zone:'Z3', purdue:'L0', slt:'SL-T 1-2', vendor:'TraceTek TT-1000 / RLE SeaHawk',
      attrs:{ accuracy:'<1 m location', media:'water and glycol' },
      surface:['Liquid cooling requires detection at every CDU, manifold and quick-disconnect.'] });
  N('row1_th','Row 01 temp/humidity','T/RH sensor','BMS','Data hall','BMS_row01_th_sensor_0',
    { zone:'Z3', purdue:'L0', slt:'SL-T 1', standards:'ASHRAE TC 9.9',
      attrs:{ band:'18-27 \u00b0C cold aisle, 8-80 % dew point' } });
  ...
  N('vesda','Row 01 VESDA sampling pipe','Aspirating smoke detection','FA','Data hall','FA_row01_vesda_pipe',
    { zone:'Z3', purdue:'L0', slt:'SL-T 2', vendor:'Xtralis VESDA-E', standards:'TIA-942-C (mandated)',
      attrs:{ sensitivity:'\u2264 0.005 % obs/ft' },
      surface:['Detector \u2192 FACP is a supervised Z3 \u2192 Z4 conduit.'] });
  ...
  N('nozzle','Row 01 suppression nozzle','Discharge nozzle','FA','Data hall','FA_row01_nozzle_-7',
    { zone:'Z4', purdue:'SIS', slt:'SL-T 2', standards:'NFPA 2001' });
  ...
  N('row1_eor','Row 01 distribution switch','Distribution switch','DATA','Data hall','DATA_row01_eor_rack_dist_switch_0',
    { zone:'Z0', purdue:'L4', slt:'SL-T 2', vendor:'Arista / Cisco', standards:'IEC 62443-4-2' });
  ...
  N('row1_oob','Row 01 OOB console','Serial console server','DATA','Data hall','DATA_row01_eor_rack_oob_console',
    { zone:'Z5', purdue:'L3.5', slt:'SL-T 3', vendor:'Vertiv ACS8000',
      surface:['Out-of-band path bypasses in-band controls — SL-T 3 and jump-host-only access.'] });
  ...
  E('rpp','busway','electricity','Physical flow','busway riser','PWR_rpp_riser');
  E('rpp_b','busway','electricity','Physical flow','busway riser (B)','PWR_rpp_riser');
  E('busway','row1_busway','electricity','Physical flow','row feed','PWR_spine_to_row01');
  E('row1_busway','row1_tap','electricity','Physical flow','tap-off','PWR_row01_tapbox_0');
  ...
  E('fws_spine','row1_cdu','water','Physical flow','FWS drop to CDU','CHW_fws_to_row01_s');
  E('row1_cdu','fws_spine','water','Physical flow','FWS return','CHW_fws_to_row01_r');
  E('row1_cdu','row1_tcs','water','Physical flow','TCS header (secondary loop)','CHW_row01_tcs_header_supply');
  E('row1_tcs','row1_rack1','water','Physical flow','rack manifold via quick-disconnect','CHW_row01_drop_supply_0');
  E('row1_rack1','rack1_compute','water','Physical flow','cold plate on die',null);

  // ---- air ----
  E('ahu','crah','air','Physical flow','outside air duct','AIR_ahu_duct');
  E('crah','row1_rack1','air','Physical flow','cold aisle supply',null);
  E('crah_b','row1_rack1','air','Physical flow','cold aisle supply',null);
  ...
  E('fiber_spine','row1_eor','data','Ethernet/TCP-IP','row trunk','DATA_spine_to_row01');
  E('row1_eor','row1_patch','data','Ethernet/TCP-IP','structured cabling',null);
  ...
  E('oob','row1_oob','data','Ethernet/TCP-IP','OOB management network',null);
  E('row1_oob','row1_tor','data','RS-232 console','serial console',null);
  ...
  // ---- OT control ----
  E('row1_cdu_plc','row1_cdu','control','Modbus RTU','pump + valve control',null,
    { critical:true, note:'Direct cyber-physical authority; thermal runaway within ~90 s if defeated.' });
  E('row1_cdu_plc','ot_sw','control','Modbus TCP','CDU telemetry','DATA_OT_branch_hall_bms');
  E('row1_leak','row1_cdu_plc','control','Dry contact','leak alarm contact',null);
  E('row1_th','gw','control','BACnet MS/TP','aisle temp / RH','DATA_OT_branch_hall_bms');
  E('chiller_ctl','chiller','control','Modbus RTU','compressor + valve control',null);
  E('chiller_ctl','chiller_b','control','Modbus RTU','plant sequencing',null);
  E('chiller_ctl','gw','control','BACnet/IP','chiller plant telemetry','DATA_OT_trunk');
  ...
  // ---- fire (Z4, isolated) ----
  E('vesda','facp','fire','Dry contact','supervised detection loop','FA_row01_vesda_pipe',
  ...
  E('bottles','nozzle','fire','Physical flow','agent discharge',null);
  ...
  N('app_cooling','Cooling plant manager','Application server','CHW','Core IT room','APP_cooling_plant_mgr',
    { zone:'Z1', purdue:'L3', slt:'SL-T 2-3',
      surface:['Holds plant sequencing logic — compromise here reaches every chiller and CDU.'] });
  ...
  N('scada_a','SCADA server A','SCADA','OT','Core IT room','SCADA_server_a',
    { zone:'Z2', purdue:'L2', slt:'SL-T 3', standards:'IEC 62443-4-2',
      surface:['Supervisory command authority over the electrical and mechanical plant.'] });
  ...
  N('tower_vfd','Cooling tower fan VFD','Variable frequency drive','CHW','Chiller room','CHW_tower_fan_vfd_0',
    { zone:'Z2', purdue:'L1-L2', slt:'SL-T 2', vendor:'ABB ACQ580' });
  ...
  E('app_cooling','chiller_ctl','control','BACnet/IP','chiller plant sequencing',null, { critical:true, cross:'Z1 \\u2192 Z2' });
  E('app_cooling','row1_cdu_plc','control','Modbus TCP','CDU setpoint supervision',null, { critical:true });
