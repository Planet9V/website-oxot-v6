...
function buildGraph(THREE, root) {
  ...
  N('chiller','Chiller 30XW','Water-cooled centrifugal chiller','CHW','Central plant (shared)','CHW_chiller_carrier_30xw',
  ...
  N('chiller_b','Chiller CenTraVac','Water-cooled chiller','CHW','Central plant (shared)','CHW_chiller_trane_cvhf',
    { zone:'Z2', purdue:'L2', slt:'SL-T 2-3', vendor:'Trane CenTraVac' });
  N('chiller_c','Chiller YZ magnetic-bearing','Water-cooled chiller','CHW','Central plant (shared)','CHW_chiller_york_yz',
    { zone:'Z2', purdue:'L2', slt:'SL-T 2-3', vendor:'York / JCI YZ', attrs:{ efficiency:'COP 6-8 at part load' } });
  N('chiller_ctl','Chiller plant controller','Unit controller','BMS','Central plant (shared)','BMS_chiller_carrier_30xw_optiview',
  ...
  N('pump','Primary CHW pump 1','Centrifugal pump','CHW','Central plant (shared)','CHW_pump_grundfos_0',
    { zone:'Z3', purdue:'L0', slt:'SL-T 1', vendor:'Grundfos', standards:'ASHRAE TC 9.9' });
  N('pump_b','Primary CHW pump 2','Centrifugal pump','CHW','Central plant (shared)','CHW_pump_grundfos_1',
    { zone:'Z3', purdue:'L0', slt:'SL-T 1', vendor:'Grundfos', attrs:{ role:'N+1' } });
  N('vfd','Pump VFD ACQ580','Variable frequency drive','CHW','Central plant (shared)','CHW_vfd_abb_acq580_0',
  ...
  N('vfd_b','Pump VFD 2','Variable frequency drive','CHW','Central plant (shared)','CHW_vfd_abb_acq580_1',
    { zone:'Z2', purdue:'L1-L2', slt:'SL-T 2', vendor:'ABB ACQ580' });
  N('wts_plc','Water treatment PLC','PLC','BMS','Central plant (shared)','BMS_wts_plc_s71200',
  ...
  N('tower_vfd','Cooling tower fan VFD','Variable frequency drive','CHW','Central plant (shared)','CHW_tower_fan_vfd_0',
    { zone:'Z2', purdue:'L1-L2', slt:'SL-T 2', vendor:'ABB ACQ580' });
