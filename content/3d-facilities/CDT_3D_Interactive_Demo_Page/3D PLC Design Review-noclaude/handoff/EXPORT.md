...
216 critical conduits · 188 hardwired/serial · 5,981 meshes · 2 cells.
...
3. Click **Download GLB** → `hyperscale_campus.glb` (~5,981 meshes, hierarchy preserved)
...
Expect `meshes_in` ≈ 5,981, `assets_bound` = 449, `routes_built` = 1,155,
