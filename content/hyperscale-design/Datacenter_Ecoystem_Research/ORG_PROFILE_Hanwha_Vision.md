...
## Hanwha Vision Co., Ltd. - Tetrel Prospect Research Dossier
...
| Field | Data | Source |
|---|---|---|
| **Full Legal Name** | Hanwha Vision Co., Ltd. (Subsidiary of Hanwha Group) | Corporate registry |
| **Legal Form** | Publicly traded or private corporation | SEC filing / Exchange registry |
| **Headquarters Address** | Seongnam, South Korea | Corporate registry |
| **Founded** | 1990 | History registry |
| **President & CEO** | Kichul Kim | Corporate profile |
| **Employees (Global)** | 1,800 | Annual report (FY2025) |
| **Website** | https://www.hanwhavision.com | - |
| **Product Security** | secure.cctv@hanwha.com | Verified search |

### 1.2 Financial Performance (FY2023-FY2025)

| Metric | FY2025 | FY2024 | FY2023 |
|---|---|---|---|
| **Total Revenue** | $850M | $780M | $710M |
| **Year-over-Year Growth** | +8.9% | - | - |
| **EBITDA Margin** | 13.2% | - | - |
| **R&D Spending** | 11.5% of sales | - | - |
| **Free Cash Flow** | $72M | - | - |
...
Hanwha Vision Co., Ltd. (Subsidiary of Hanwha Group) operates through major regional and product divisions, focusing on data center infrastructure and industrial controls. It has institutional and regional ownership with sales globally.
...
|---|---|---|---|---|
| **Wisenet Cameras** | Wisenet X-series, Q-series | IP Network | Network surveillance camera | N/A |
| **Hanwha NVRs** | PRN, XRN series | IP Network | Network video recorder | Up to 128 channels |
| **SightMind Integration** | AI Analytics | Cloud/Edge software | Business intelligence package | N/A |
...
*   **Known Vulnerabilities:** CVE-2023-5037 (Camera privilege escalation CVSS 8.8)
...
|---|---|---|---|
| **Kichul Kim** | Chief Executive Officer | Group | South Korea |
| **Choong Hoon Ha** | Chief Sales & Marketing Officer | Sales | South Korea |
...
*   Week 1: Contact CSMO Choong Hoon Ha. Present an IEC 62443 compliance roadmap for Wisenet cameras.
*   Week 2: Contact CEO Kichul Kim. Present a CRA risk audit report for their European divisions.

#### Proposed Service Packages

| Service Package | Scope | Price (CAD) | Timeline |
|---|---|---|---|
| **Wisenet Camera 62443 Audit** | Conformity assessment of Wisenet X-series firmware against IEC 62443-4-2 standards | $85,000 | 4 weeks |
| **S-CERT Process Conformity** | Align S-CERT vulnerability disclosure timelines with CRA and CISA requirements | $70,000 | 3 weeks |
| **CRA Class II NVR Compliance Audit** | Verify secure boot and firmware signatures on PRN/XRN network video recorders | $95,000 | 4 weeks |

---

### 6.4 Sources & Citations
1.  Hanwha Vision Co., Ltd. (Subsidiary of Hanwha Group). (2025). *Consolidated Financial Statements & Annual Report 2024*.
...
---
*END OF PROFILE - HANWHA VISION - 6 PAGES*
