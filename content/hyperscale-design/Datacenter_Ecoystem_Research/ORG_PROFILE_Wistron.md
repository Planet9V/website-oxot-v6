...
## Wistron Corporation -  Prospect Research Dossier
...
| Field | Data | Source |
|:-|:-|:-|
| **Full Legal Name** | Wistron Corporation | Corporate registry |
...
| **Founded** | 2001 | History registry |
| **President & CEO** | Jeff Lin | Corporate profile |
| **Employees (Global)** | ~80,000 | Annual report (FY2025) |
...
|:-|:-|:-|:-|
| **Total Revenue** | NT$2.190T (approx $89.79B CAD, TTM) | NT$1.049T (approx $43.01B CAD) | NT$1.222T (approx $50.10B CAD) |
| **Year-over-Year Growth** | +108% YoY | - | - |
| **EBITDA Margin** | Not disclosed (Net profit margin 1.18%) | - | - |
| **R&D Spending** | Not disclosed | - | - |
| **Free Cash Flow** | Not disclosed (Debt-to-equity ratio 167.38%) | - | - |
...
Wistron Corporation operates through major regional and product divisions, focusing on data center infrastructure and industrial controls. It has institutional and regional ownership with sales globally.
...
|:-|:-|:-|:-|:-|
| **AI Servers** | Blackwell Server Edition | PCIe / GPU | High Performance Server System | NVIDIA HGX partner, Blackwell GPU support |
| **Laptops** | Notebook ODM | x86 / ARM | ODM Personal Computer | Manufactured for Apple, Dell, HP, Lenovo |
| **Smart Cockpit** | In-Vehicle Platform | CAN / Ethernet | Automotive Infotainment System | Level 2-4 autonomous driving support |
...
*   **Known Vulnerabilities:** Zero direct end-customer CVEs (disclosed under customer brands)
...
|:-|:-|:-|:-|
| **Jeff Lin** | President & CEO | Group Management | Taiwan |
| **Simon Lin** | Chairman & CSO | Group Management | Taiwan |
| **Kenny Wang** | Chief Digital Officer & CISO | IT/Security | Taiwan |
| **David Shen** | Chief Technology Officer | R&D | Taiwan |
...
*   Week 1: Contact CISO Kenny Wang. Propose a supply chain SBOM validation and secure configuration review of their manufacturing network.
*   Week 2: Contact CTO David Shen. Discuss automated firmware vulnerability scans and secure boot validation for AI server platforms.
*   Week 3: Connect with CEO Jeff Lin. Present a CRA conformity gap analysis for servers and embedded systems exported to the EU.

#### Proposed Service Packages

| Service Package | Scope | Price (CAD) | Timeline |
|:-|:-|:-|:-|
| **AI Server Firmware Integrity Review** | Security validation of secure boot and firmware signature checks on Blackwell server platforms | $125,000 | 5 weeks |
| **Manufacturing SBOM Automation** | Automate SBOM generation and third-party software auditing for enterprise computing lines | $110,000 | 4 weeks |
| **CRA Class II Compliance Gap Analysis** | Conformity assessment of Wistron server and edge systems against CRA requirements | $95,000 | 4 weeks |

:-

### 6.4 Sources & Citations
1.  Wistron Corporation. (2025). *Consolidated Financial Statements & Annual Report 2024*.
...
:-
*END OF PROFILE - WISTRON - 6 PAGES*
