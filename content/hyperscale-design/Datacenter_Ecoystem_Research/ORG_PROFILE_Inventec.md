...
## Inventec Corporation     Prospect Research Dossier
...
| Field | Data | Source |
|:-|:-|:-|
| **Full Legal Name** | Inventec Corporation (英業達股份有限公司) | Corporate registry |
| **Legal Form** | Publicly traded or private corporation | SEC filing / Exchange registry |
| **Headquarters Address** | Taipei City, Taiwan | Corporate registry |
| **Founded** | 1975 | History registry |
| **President & CEO** | Yung Tsai Wu | Corporate profile |
| **Employees (Global)** | 28,864 | Annual report (FY2025) |
...
|:-|:-|:-|:-|
| **Total Revenue** | $20.10B USD (approx $30.15B CAD) | $16.70B USD (approx $25.05B CAD) | $18.20B USD (approx $27.30B CAD) |
| **Year-over-Year Growth** | +6.95% in USD | - | - |
...
Inventec Corporation (英業達股份有限公司) operates through major regional and product divisions, focusing on data center infrastructure and industrial controls. It has institutional and regional ownership with sales globally.
...
|:-|:-|:-|:-|:-|
| **P9000 Series AI Server** | P9000G7 / P8000IG6 | IP Network, Liquid Cooling | High-density GPU server rack | Supports 8x NVIDIA HGX B300/B200 GPUs |
| **Artemis Rack System** | Artemis GB300 NVL72 | IP, Liquid | NVIDIA MGX modular rack system | 44OU rack form factor |
| **DCS7032Q28 Switch** | DCS7032Q28 | QSFP28, Fiber | OCP Leaf/Spine switch fabric | 32 ports, 3.2 Tbps aggregate bandwidth |
...
|:-|:-|:-|:-|
| **Yung Tsai Wu** | Chief Executive Officer | Group | Taiwan |
| **George Lin** | VP Enterprise Business Group | Enterprise | Taiwan |
| **Chin Pao Yu** | Chief Financial Officer | Finance | Taiwan |
...
*   Week 1: Contact George Lin, VP of Enterprise Business Group. Propose a secure code review of BMC firmware on P8000IG6 platforms.
*   Week 2: Contact CEO Samuel Tsai Wu. Discuss OCP S.A.F.E. pre-audit for upcoming GB300 NVL72 rack designs.
*   Week 3: Connect with CFO Chin Pao Yu. Outline Cyber Resilience Act compliance roadmap to protect Czech assembly sales.

#### Proposed Service Packages

| Service Package | Scope | Price (CAD) | Timeline |
|:-|:-|:-|:-|
| **P8000IG6 BMC Firmware Audit** | Vulnerability review and threat model of ASPEED BMC software on HGX platforms | $115,000 | 5 weeks |
| **OCP S.A.F.E. Compliance Prep** | Motherboard and firmware security validation against OCP secure hardware standards | $95,000 | 4 weeks |
| **CRA Class II Product Compliance Prep** | Audit connected server lines against Cyber Resilience Act Class II requirements | $110,000 | 5 weeks |

:-

### 6.4 Sources & Citations
1.  Inventec Corporation (英業達股份有限公司). (2025). *Consolidated Financial Statements & Annual Report 2024*.
...
:-
*END OF PROFILE - INVENTEC - 6 PAGES*
