...
## Celestica Inc. - Tetrel Prospect Research Dossier
...
| Field | Data | Source |
|:-|:-|:-|
| **Full Legal Name** | Celestica Inc. | Corporate registry |
| **Legal Form** | Publicly traded or private corporation | SEC filing / Exchange registry |
| **Headquarters Address** | Toronto, Ontario, Canada | Corporate registry |
| **Founded** | 1994 | History registry |
| **President & CEO** | Rob Mionis | Corporate profile |
| **Employees (Global)** | 26,865 | Annual report (FY2025) |
| **Website** | https://www.celestica.com | - |
| **Product Security** | No public PSIRT (managed via IT/Security) | Verified search |

### 1.2 Financial Performance (FY2023-FY2025)

| Metric | FY2025 | FY2024 | FY2023 |
|:-|:-|:-|:-|
| **Total Revenue** | $12.61B USD (approx $18.92B CAD) | $9.65B USD (approx $14.47B CAD) | $7.96B USD (approx $11.94B CAD) |
| **Year-over-Year Growth** | +30.7% | - | - |
| **EBITDA Margin** | Not disclosed | - | - |
| **R&D Spending** | Not disclosed | - | - |
| **Free Cash Flow** | $305.9M USD (approx $458.9M CAD) | - | - |
...
Celestica Inc. operates through major regional and product divisions, focusing on data center infrastructure and industrial controls. It has institutional and regional ownership with sales globally.
...
|:-|:-|:-|:-|:-|
| **Connectivity & Cloud Solutions (CCS)** | Connectivity and Cloud Systems | IP Network, Hardware | Custom data center networking | Hyperscaler custom build |
| **Advanced Technology Solutions (ATS)** | ATS High-Reliability | Specialized interface, ITAR | Aerospace & Defense electronics | NIST 800-171 certified systems |
| **Hardware Platform Solutions (HPS)** | HPS Storage/Compute | IP, PCIe | Proprietary design platform | Targeting 30% segment revenue by 2027 |
...
|:-|:-|:-|:-|
| **Rob Mionis** | Chair & CEO | Group | Canada |
| **Laurette Koellner** | Lead Independent Director | Board | USA |
| **Amar Maletira** | Chair, Audit Committee | Board | USA |
...
#### Priority Score: ★★★★☆ (4/5) - High Priority Partner
...
*   Week 1: Contact CEO Rob Mionis. Present a supply chain security framework aligning NIST 800-171 controls with upcoming CRA requirements.
*   Week 2: Contact Audit Committee Chair Amar Maletira. Offer a third-party risk management audit of Celestica's global manufacturing sites.
*   Week 3: Connect with Lead Director Laurette Koellner. Discuss board-level cybersecurity oversight structures.

#### Proposed Service Packages

| Service Package | Scope | Price (CAD) | Timeline |
|:-|:-|:-|:-|
| **NIST 800-171 Security Compliance Review** | Audit aerospace and defense manufacturing systems against NIST SP 800-171 Rev 3 guidelines | $125,000 | 6 weeks |
| **ISO 27001 Information Security Audit** | Information Security Management System (ISMS) gap analysis and prep audit for global sites | $95,000 | 4 weeks |
| **CRA Supply Chain Readiness Review** | Assess Celestica's CCS and HPS manufacturing lines against Cyber Resilience Act supplier requirements | $75,000 | 3 weeks |

:-

### 6.4 Sources & Citations
1.  Celestica Inc.. (2025). *Consolidated Financial Statements & Annual Report 2024*.
...
:-
*END OF PROFILE - CELESTICA - 6 PAGES*
