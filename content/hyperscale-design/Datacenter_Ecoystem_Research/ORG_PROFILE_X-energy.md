...
## X-energy -  Prospect Research Dossier
...
| Field | Data | Source |
|:-|:-|:-|
| **Full Legal Name** | X-Energy, Inc. | Corporate registry |
| **Legal Form** | Publicly traded or private corporation | SEC filing / Exchange registry |
| **Headquarters Address** | Rockville, Maryland, USA | Corporate registry |
| **Founded** | 2009 | History registry |
| **President & CEO** | J. Clay Sell | Corporate profile |
| **Employees (Global)** | ~988 | Annual report (FY2025) |
| **Website** | https://x-energy.com | - |
| **Product Security** | No public PSIRT (managed via IT/Compliance) | Verified search |

### 1.2 Financial Performance (FY2023-FY2025)

| Metric | FY2025 | FY2024 | FY2023 |
|:-|:-|:-|:-|
| **Total Revenue** | TBD (IPO April 2026) | $83.99M USD (approx $125.99M CAD) | $104.89M USD (approx $157.34M CAD) |
| **Year-over-Year Growth** | -19.9% (shifting revenue mix) | - | - |
| **EBITDA Margin** | ($211.0M) (R&D and scaling loss) | - | - |
| **R&D Spending** | $45.2M USD (approx $67.8M CAD) | - | - |
| **Free Cash Flow** | -$237.9M USD (approx -$356.85M CAD) | - | - |
...
X-Energy, Inc. operates through major regional and product divisions, focusing on data center infrastructure and industrial controls. It has institutional and regional ownership with sales globally.
...
|:-|:-|:-|:-|:-|
| **Xe-100 SMR Module** | Xe-100 (80 MWe) | Helium Gas / Graphite | High-temperature gas-cooled pebble-bed reactor | 80 MWe (200 MWth) per module |
| **Xe-100 Four-Unit Plant** | Xe-100-4 | Helium Gas / Graphite | Multi-module advanced nuclear power plant | 320 MWe (640 MWth) |
| **TRISO-X Fuel Pebbles** | TRISO-X | TRISO Silicon Carbide | High-temperature gas-cooled reactor pebble fuel | TRISO fuel fabrication |
...
|:-|:-|:-|:-|
| **J. Clay Sell** | Chief Executive Officer | Group | USA |
| **Daniel Gross** | Chief Financial Officer | Finance | USA |
| **Martin van Staden** | Chief Technology Officer | R&D | USA |
...
*   Week 1: Contact CEO J. Clay Sell. Present an integrated CDAQ system security audit proposal aligning with NRC 10 CFR 73.54 rules.
*   Week 2: Contact CFO Daniel Gross. Highlight financial and liability risk reduction for Amazon/Dow partnerships via third-party audit.
*   Week 3: Connect with CTO Martin van Staden. Discuss secure engineering controls for Xe-100 digital controls.

#### Proposed Service Packages

| Service Package | Scope | Price (CAD) | Timeline |
|:-|:-|:-|:-|
| **Xe-100 CDAQ Digital Security Audit** | Secure code review and threat model of the Xe-100 Plant Control and Data Acquisition System | $135,000 | 6 weeks |
| **TRISO-X Factory OT Security Review** | Vulnerability audit and network segmentation review for the TRISO-X TX-1 fuel fabrication plant | $120,000 | 5 weeks |
| **10 CFR 73.54 Security Program Audit** | Review of Xe-100's cybersecurity topical reports and program plans against NRC guidelines | $115,000 | 5 weeks |

:-

### 6.4 Sources & Citations
1.  X-Energy, Inc.. (2025). *Consolidated Financial Statements & Annual Report 2024*.
...
:-
*END OF PROFILE - X-ENERGY - 6 PAGES*
