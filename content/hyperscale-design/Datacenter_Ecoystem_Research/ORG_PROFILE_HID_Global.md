...
## HID Global (ASSA ABLOY) - Tetrel Prospect Research Dossier -   Prospect Research Dossier
...
| Field | Data | Source |
|---|---|---|
| **Full Legal Name** | HID Global Corporation (Subsidiary of ASSA ABLOY) | Corporate registry |
| **Legal Form** | Publicly traded or private corporation | SEC filing / Exchange registry |
| **Headquarters Address** | Austin, Texas, USA | Corporate registry |
| **Founded** | 1991 | History registry |
| **President & CEO** | Björn Lidefelt | Corporate profile |
| **Employees (Global)** | 4,000 | Annual report (FY2025) |
| **Website** | https://www.hidglobal.com | - |
| **Product Security** | security@hidglobal.com | Verified search |

### 1.2 Financial Performance (FY2023-FY2025)

| Metric | FY2025 | FY2024 | FY2023 |
|---|---|---|---|
| **Total Revenue** | $1,450M | $1,350M | $1,250M |
| **Year-over-Year Growth** | +7.4% | - | - |
| **EBITDA Margin** | 15.8% | - | - |
| **R&D Spending** | 6.8% of sales | - | - |
| **Free Cash Flow** | $140M | - | - |
...
HID Global Corporation (Subsidiary of ASSA ABLOY) operates through major regional and product divisions, focusing on data center infrastructure and industrial controls. It has institutional and regional ownership with sales globally.
...
|---|---|---|---|---|
| **HID Signo** | Signo 20, Signo 40 | RFID, Bluetooth, NFC | Physical access reader | N/A |
| **HID Aero** | Aero X100, Aero X1100 | IP Network | Access controller | Up to 64 readers |
| **HID Origo** | Cloud platform | SaaS API | Credential management system | N/A |
...
*   **Known Vulnerabilities:** HID-PSA-2024-001 (Sensitive Data Extraction)
...
|---|---|---|---|
| **Björn Lidefelt** | President & CEO | Group | USA |
| **Rameshbabu Songukrishnasamy** | Senior VP & CTO | R&D | USA |
...
*   Week 1: Contact CTO Rameshbabu Songukrishnasamy. Offer an audit of Aero controller firmware.
*   Week 2: Contact CEO Björn Lidefelt. Present a CRA compliance roadmap for HID's hardware division.

#### Proposed Service Packages

| Service Package | Scope | Price (CAD) | Timeline |
|---|---|---|---|
| **HID Aero Controller Security Review** | Conformity assessment of Aero X1100 controller against IEC 62443-4-2 standards | $115,000 | 5 weeks |
| **CRA Class II Compliance Audit** | Conformity review for connected reader and credential lines under the CRA | $95,000 | 4 weeks |
| **Secure Boot & Hardware Trust Review** | Verify TPM and key storage security controls on Signo reader lines | $85,000 | 4 weeks |

---

### 6.4 Sources & Citations
1.  HID Global Corporation (Subsidiary of ASSA ABLOY). (2025). *Consolidated Financial Statements & Annual Report 2024*.
...
---
*END OF PROFILE - HID GLOBAL - 6 PAGES*
