...
## Dragos, Inc. - Tetrel Prospect Research Dossier
...
| Field | Data | Source |
|---|---|---|
| **Full Legal Name** | Dragos, Inc. | Corporate registry |
| **Legal Form** | Publicly traded or private corporation | SEC filing / Exchange registry |
| **Headquarters Address** | Hanover, Maryland, USA | Corporate registry |
| **Founded** | 2016 | History registry |
| **President & CEO** | Robert M. Lee | Corporate profile |
| **Employees (Global)** | 400 | Annual report (FY2025) |
| **Website** | https://www.dragos.com | - |
| **Product Security** | https://www.dragos.com/ot-cert | Verified search |

### 1.2 Financial Performance (FY2023-FY2025)

| Metric | FY2025 | FY2024 | FY2023 |
|---|---|---|---|
| **Total Revenue** | $110M | $90M | $75M |
| **Year-over-Year Growth** | +22.2% | - | - |
| **EBITDA Margin** | 6.5% | - | - |
| **R&D Spending** | 15.8% of sales | - | - |
| **Free Cash Flow** | -$8M | - | - |
...
Dragos, Inc. operates through major regional and product divisions, focusing on data center infrastructure and industrial controls. It has institutional and regional ownership with sales globally.
...
|---|---|---|---|---|
| **Dragos Platform** | Dragos Platform v2.0 | IP, Network, Mirror | OT Visibility & Threat Detection | Distributed sensor deployments |
| **Dragos WorldView** | WorldView Threat Intelligence | SaaS / Portal | Industrial Threat Intelligence | Global threat feed access |
| **OT Watch** | OT Watch managed hunting | SaaS / Sensor | Managed threat hunting | 24/7 expert monitoring |
...
|---|---|---|---|
| **Robert M. Lee** | CEO & Co-Founder | Group | USA |
| **Jon Lavender** | CTO & Co-Founder | R&D | USA |
| **Ben Miller** | Chief Information Security Officer | Security | USA |
...
*   Week 1: Contact CEO Robert M. Lee. Outline how Tetrel's nuclear I&C security reviews (NRC 73.54) complement Dragos WorldView threat feeds.
*   Week 2: Contact CTO Jon Lavender. Discuss sensor secure coding audits and IEC 62443-4-1 compliance support.
*   Week 3: Connect with CISO Ben Miller. Offer a secure SDLC pre-audit of the central Dragos Platform server.

#### Proposed Service Packages

| Service Package | Scope | Price (CAD) | Timeline |
|---|---|---|---|
| **Dragos Sensor Firmware Audit** | Secure code review and threat modeling of Dragos sensor hardware interface modules | $95,000 | 5 weeks |
| **Joint SMR Cybersecurity Framework** | Build a secure operational technology framework combining Dragos threat intelligence with Tetrel NRC 73.54 compliance plan | $125,000 | 6 weeks |
| **CRA conformity review for Dragos Platform** | Map Dragos software products to Cyber Resilience Act Class II compliance gates | $70,000 | 3 weeks |

---

### 6.4 Sources & Citations
1.  Dragos, Inc.. (2025). *Consolidated Financial Statements & Annual Report 2024*.
