...
## Kairos Power -   Prospect Research Dossier
...
| Field | Data | Source |
|:-|:-|:-|
| **Full Legal Name** | Kairos Power LLC | Corporate registry |
| **Legal Form** | Publicly traded or private corporation | SEC filing / Exchange registry |
| **Headquarters Address** | Alameda, California, USA | Corporate registry |
| **Founded** | 2016 | History registry |
| **President & CEO** | Mike Laufer | Corporate profile |
| **Employees (Global)** | ~350 | Annual report (FY2025) |
| **Website** | https://kairospower.com | - |
| **Product Security** | No public PSIRT (managed via IT/Operations) | Verified search |

### 1.2 Financial Performance (FY2023-FY2025)

| Metric | FY2025 | FY2024 | FY2023 |
|:-|:-|:-|:-|
| **Total Revenue** | Private (Pre-revenue) | Private (Pre-revenue) | Private (Pre-revenue) |
| **Year-over-Year Growth** | N/A (Backed by Google PPA) | - | - |
| **EBITDA Margin** | Not disclosed (Private) | - | - |
| **R&D Spending** | Not disclosed (Private) | - | - |
...
Kairos Power LLC operates through major regional and product divisions, focusing on data center infrastructure and industrial controls. It has institutional and regional ownership with sales globally.
...
|:-|:-|:-|:-|:-|
| **KP-150 SMR Module** | KP-150 (150 MWe) | Liquid FLiBe Salt / TRISO Pebbles | Fluoride salt-cooled high-temperature reactor | 150 MWe (Baseload) capacity |
| **Hermes 1 Demo Reactor** | Hermes 1 (35 MWth) | Liquid FLiBe Salt | Demonstration molten salt reactor under construction | 35 MWth (Non-Power) capacity |
| **Hermes 2 Demo Reactor** | Hermes 2 (50 MWe) | Liquid FLiBe Salt | Two-unit molten salt power plant | 50 MWe (Power) capacity |
...
|:-|:-|:-|:-|
| **Mike Laufer** | CEO & Co-founder | Group | USA |
| **Edward Blandford** | CTO & Co-founder | R&D | USA |
| **Ravi Singaraju** | VP Engineering Design & Integration | Engineering | USA |
...
*   Week 1: Contact CEO Mike Laufer. Propose a secure SDLC and SBOM audit for the Hermes 1 control systems to support licensing.
*   Week 2: Contact CTO Edward Blandford. Discuss secure instrumentation and telemetry encryption for high-temperature salt loops.
*   Week 3: Connect with VP Ravi Singaraju. Detail firmware signature validation controls for reactor integration.

#### Proposed Service Packages

| Service Package | Scope | Price (CAD) | Timeline |
|:-|:-|:-|:-|
| **Hermes Control System Secure Audit** | Threat model and code review of the Hermes demonstration reactor control software | $130,000 | 6 weeks |
| **10 CFR 73.54 Security Program Review** | Verify Kairos cybersecurity plan against NRC requirements for commercial SMR deployments | $115,000 | 5 weeks |
| **Molten Salt Loop Telemetry Audit** | Security assessment of sensor data loops and actuator interfaces in engineering test units | $95,000 | 4 weeks |

:-

### 6.4 Sources & Citations
1.  Kairos Power LLC. (2025). *Consolidated Financial Statements & Annual Report 2024*.
...
:-
*END OF PROFILE - KAIROS POWER - 6 PAGES*
