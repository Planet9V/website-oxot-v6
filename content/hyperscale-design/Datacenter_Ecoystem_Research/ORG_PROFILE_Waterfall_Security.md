...
## Waterfall Security Solutions Ltd. - Prospect Research Dossier
...
| Field | Data | Source |
|---|---|---|
| **Full Legal Name** | Waterfall Security Solutions Ltd. | Corporate registry |
| **Legal Form** | Publicly traded or private corporation | SEC filing / Exchange registry |
| **Headquarters Address** | Rosh HaAyin, Israel | Corporate registry |
| **Founded** | 2007 | History registry |
| **President & CEO** | Lior Frenkel | Corporate profile |
| **Employees (Global)** | 130 | Annual report (FY2025) |
| **Website** | https://waterfall-security.com | - |
| **Product Security** | No public PSIRT (managed via support/R&D) | Verified search |

### 1.2 Financial Performance (FY2023-FY2025)

| Metric | FY2025 | FY2024 | FY2023 |
|---|---|---|---|
| **Total Revenue** | $35M | $27M | $22M |
| **Year-over-Year Growth** | +29.6% | - | - |
| **EBITDA Margin** | 12.0% | - | - |
| **R&D Spending** | 14.5% of sales | - | - |
| **Free Cash Flow** | $3M | - | - |
...
Waterfall Security Solutions Ltd. operates through major regional and product divisions, focusing on data center infrastructure and industrial controls. It has institutional and regional ownership with sales globally.
...
|---|---|---|---|---|
| **Unidirectional Security Gateway** | WF-500 Standard | IP, Fiber, Diode | Hardware-enforced data diode | Up to 10 Gbps throughput |
| **Waterfall FLIP** | FLIP reversible gateway | Fiber, Relay | Scheduled Unidirectional Gateway | Bidirectional capability with hardware lock |
| **Waterfall OT CloudConnect** | CloudConnect Gateway | IP, Cloud | Secure cloud data exporter | Supports OPC UA, MQTT, Kafka |
...
|---|---|---|---|
| **Lior Frenkel** | CEO and Co-Founder | Group | Israel |
| **Ran Pedhazur** | Chief Operating Officer | Operations | Israel |
| **Andrew Ginter** | VP Industrial Security | Product Security | Canada |
...
*   Week 1: Contact VP Industrial Security Andrew Ginter. Propose a joint whitepaper mapping data diodes to IEC 62443-3-3 compliance.
*   Week 2: Contact CEO Lior Frenkel. Present co-sell opportunities for Canadian nuclear SMR projects.
*   Week 3: Connect with COO Ran Pedhazur. Offer a secure SDLC pre-audit of the CloudConnect gateway software.

#### Proposed Service Packages

| Service Package | Scope | Price (CAD) | Timeline |
|---|---|---|---|
| **WF-500 Firmware Security Audit** | Secure code audit and hardware trust validation for WF-500 security modules | $85,000 | 4 weeks |
| **Joint SMR Unidirectional Architecture** | Establish a secure reference architecture combining Waterfall diodes with Tetrel's zone zoning models | $115,000 | 6 weeks |
| **CRA conformity review for FLIP** | Assess the Waterfall FLIP reversible gateway against CRA Class II requirements | $70,000 | 3 weeks |

---

### 6.4 Sources & Citations
1.  Waterfall Security Solutions Ltd.. (2025). *Consolidated Financial Statements & Annual Report 2024*.
...
---
*END OF PROFILE - WATERFALL SECURITY - 6 PAGES*
