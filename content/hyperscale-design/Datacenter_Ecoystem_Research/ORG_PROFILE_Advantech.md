...
## Advantech Co., Ltd. - Tetrel Prospect Research Dossier
...
| Field | Data | Source |
|:-|:-|:-|
| **Full Legal Name** | Advantech Co., Ltd. | Corporate registry |
| **Legal Form** | Publicly traded or private corporation | SEC filing / Exchange registry |
| **Headquarters Address** | Taipei, Taiwan | Corporate registry |
| **Founded** | 1985 | History registry |
| **President & CEO** | K.C. Liu | Corporate profile |
| **Employees (Global)** | ~8,000 | Annual report (FY2025) |
| **Website** | https://www.advantech.com | - |
| **Product Security** | ACIRT (Advantech Cyber Incident Response Team) - ACIRT@advantech.com | Verified search |

### 1.2 Financial Performance (FY2023-FY2025)

| Metric | FY2025 | FY2024 | FY2023 |
|:-|:-|:-|:-|
| **Total Revenue** | $1.95B USD (approx $2.925B CAD, estimated) | $1.869B USD (approx $2.80B CAD) | $2.016B USD (approx $3.02B CAD) |
| **Year-over-Year Growth** | -7.4% YoY | - | - |
| **EBITDA Margin** | NT$10.5B (approx $490M CAD) | - | - |
| **R&D Spending** | NT$5.415B (approx $250M CAD, 9% of revenue) | - | - |
| **Free Cash Flow** | NT$10.510B (approx $490M CAD) | - | - |
...
Advantech Co., Ltd. operates through major regional and product divisions, focusing on data center infrastructure and industrial controls. It has institutional and regional ownership with sales globally.
...
|:-|:-|:-|:-|:-|
| **Embedded Computing Modules** | ROM-2860 / COM-HPC | COM Express, PCIe, I2C | Edge AI and IoT computing boards with ARM/x86 | ROM-2860 award-winning edge AI board |
| **Industrial Computers & HMIs** | ARK fanless box PCs / Panel PCs | Modbus, EtherNet/IP, Ethernet | Rugged fanless industrial box PCs and panels | 7" to 24" displays, MIL-STD-810 ruggedization |
| **WISE-IoT & WISE-DeviceOn** | WISE-DeviceOn v5.x | HTTP/HTTPS, MQTT, SQL | Edge intelligence and remote device management platform | Remote software deployment, monitoring, and update server |
...
*   **Known Vulnerabilities:** CVE-2025-52694 (CVSS 10.0, SQL Injection in SaaS Composer), CVE-2025-34256 (CVSS 10.0, SQL Injection / Auth Bypass in WISE-DeviceOn), CVE-2024-2453 (CVSS 7.1, WebAccess/SCADA SQL Injection)
...
|:-|:-|:-|:-|
| **K.C. Liu** | Founder, Chairman & CEO | Group | Taiwan |
| **Eric Chen** | President of General Management, CFO & CISO | General Management & IT | Taiwan |
| **Linda Tsai** | President of Intelligent System Sector & COO | Operations & System Sector | Taiwan |
...
*   Week 1: Contact Chairman & CEO K.C. Liu. Highlight how third-party product security validations (IEC 62443-4-2) protect their 41% global market share in industrial PCs.
*   Week 2: Contact President, CFO & CISO Eric Chen. Propose a cloud/SaaS platform security audit and vulnerability remediation verification for WISE-DeviceOn.
*   Week 3: Connect with COO Linda Tsai. Discuss secure manufacturing and software supply chain audits (SBOMs) for Linkou and Kunshan factories.

#### Proposed Service Packages

| Service Package | Scope | Price (CAD) | Timeline |
|:-|:-|:-|:-|
| **WISE-DeviceOn Cloud Security Audit** | Comprehensive penetration test and secure code review of DeviceOn server code | $125,000 | 5 weeks |
| **IEC 62443-4-2 Verification Prep** | Compliance audits for AFE-E350 and ARK-3534 controllers | $110,000 | 4 weeks |
| **Supply Chain SBOM Validation** | Software Bill of Materials validation and firmware integrity review for embedded lines | $95,000 | 4 weeks |

:-

### 6.4 Sources & Citations
1.  Advantech Co., Ltd.. (2025). *Consolidated Financial Statements & Annual Report 2024*.
...
:-
*END OF PROFILE - ADVANTECH - 6 PAGES*
