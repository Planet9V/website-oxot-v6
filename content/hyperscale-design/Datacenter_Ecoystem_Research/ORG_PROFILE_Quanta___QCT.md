...
## Quanta / QCT - Prospect Research Dossier
...
| Field | Data | Source |
|---|---|---|
| **Full Legal Name** | Quanta Computer Inc. (Quanta Cloud Technology) | Corporate registry |
| **Legal Form** | Publicly traded or private corporation | SEC filing / Exchange registry |
| **Headquarters Address** | Taoyuan City, Taiwan | Corporate registry |
| **Founded** | 1988 | History registry |
| **President & CEO** | Chee-Chun (C.C.) Leung | Corporate profile |
| **Employees (Global)** | 10,000 | Annual report (FY2025) |
| **Website** | https://www.qct.io | - |
| **Product Security** | No public PSIRT (managed via IT/General Counsel) | Verified search |

### 1.2 Financial Performance (FY2023-FY2025)

| Metric | FY2025 | FY2024 | FY2023 |
|---|---|---|---|
| **Total Revenue** | $68,100M | $43,800M | $30,500M |
| **Year-over-Year Growth** | +51.0% | - | - |
| **EBITDA Margin** | 8.5% | - | - |
| **R&D Spending** | 3.5% of sales | - | - |
...
Quanta Computer Inc. (Quanta Cloud Technology) operates through major regional and product divisions, focusing on data center infrastructure and industrial controls. It has institutional and regional ownership with sales globally.
...
|---|---|---|---|---|
| **QCT QuantaGrid Server** | QuantaGrid D54Q-2U | IP, BMC | Hyperscale compute server | Dual-socket Intel Xeon Scalable |
| **QCT QuantaMesh Switch** | QuantaMesh T9000 series | IP, Fiber, QSFP | Data center network switch | Up to 100G/400G switching |
| **QCT QuantaVault Storage** | QuantaVault JBOD | SAS, IP | High-capacity JBOD storage | Up to 102 hot-swap 3.5-inch drives |
...
|---|---|---|---|
| **Chee-Chun Leung** | Co-Founder, Vice Chairman & President | Group | Taiwan |
| **Bryan Chen** | VP & Chief Information Security Officer | Security | Taiwan |
| **Jun Lie Yang** | Chief Financial Officer | Finance | Taiwan |
...
*   Week 1: Contact CISO Bryan Chen. Pitch OCP S.A.F.E. pre-audit for server motherboard firmware.
*   Week 2: Contact President C.C. Leung. Present a secure development lifecycle gap analysis focusing on BMC firmware.
*   Week 3: Connect with CFO Jun Lie Yang. Outline compliance penalty risks under EU Cyber Resilience Act.

#### Proposed Service Packages

| Service Package | Scope | Price (CAD) | Timeline |
|---|---|---|---|
| **QuantaGrid Firmware Secure Code Audit** | Secure code audit and vulnerability review for QuantaGrid BMC firmware stacks | $115,000 | 5 weeks |
| **OCP S.A.F.E. Motherboard Pre-Audit** | Conformity assessment of QuantaGrid server boards against OCP secure hardware standards | $95,000 | 4 weeks |
| **CRA Class II Product Compliance Prep** | Audit product lines against CRA Class II standards, ensuring secure boot and SBOM readiness | $110,000 | 5 weeks |

---

### 6.4 Sources & Citations
1.  Quanta Computer Inc. (Quanta Cloud Technology). (2025). *Consolidated Financial Statements & Annual Report 2024*.
...
---
*END OF PROFILE - QUANTA QCT - 6 PAGES*
