...
## Palo Alto Networks, Inc. - Prospect Research Dossier
...
| Field | Data | Source |
|---|---|---|
| **Full Legal Name** | Palo Alto Networks, Inc. | Corporate registry |
| **Legal Form** | Publicly traded or private corporation | SEC filing / Exchange registry |
| **Headquarters Address** | Santa Clara, California, USA | Corporate registry |
| **Founded** | 2005 | History registry |
| **President & CEO** | Nikesh Arora | Corporate profile |
| **Employees (Global)** | 17,027 | Annual report (FY2025) |
| **Website** | https://www.paloaltonetworks.com | - |
| **Product Security** | https://security.paloaltonetworks.com | Verified search |

### 1.2 Financial Performance (FY2023-FY2025)

| Metric | FY2025 | FY2024 | FY2023 |
|---|---|---|---|
| **Total Revenue** | $8,030M | $7,490M | $6,890M |
...
Palo Alto Networks, Inc. operates through major regional and product divisions, focusing on data center infrastructure and industrial controls. It has institutional and regional ownership with sales globally.
...
|---|---|---|---|---|
| **Prisma Access** | Prisma SASE | Cloud/IP | Security Service Edge platform | Hyperscale deployment |
| **Next-Generation Firewalls** | PA-7000, PA-5400 | IP, Fiber | Network security firewall | Up to 700 Gbps |
| **Cortex XDR** | Cortex Agent | Endpoint | Detection and response agent | Cloud-native architecture |
...
*   **Known Vulnerabilities:** Operation Lunar Peek (CVE-2025-0102)
...
|---|---|---|---|
| **Nikesh Arora** | CEO & Chairman | Group | USA |
| **BJ Jenkins Jr.** | President | Operations | USA |
| **Lee Klarich** | Chief Product & Technology Officer | R&D | USA |
| **Meerah Rajavel** | Chief Information Officer | IT | USA |
| **[PSIRT Lead]** | PSIRT Lead (unnamed) | Product Security | USA |
...
*   Week 1: Contact CPTO Lee Klarich. Pitch OCP S.A.F.E. firmware review for firewall management cards.
*   Week 2: Contact President BJ Jenkins Jr. Present a CRA compliance roadmap for hardware firewall product lines.
*   Week 3: Connect with CIO Meerah Rajavel. Highlight supply chain security standards (IEC 62443-4-1) for integrated acquisitions.

#### Proposed Service Packages

| Service Package | Scope | Price (CAD) | Timeline |
|---|---|---|---|
| **Firewall Firmware Conformity Audit** | Conformity assessment of hardware firewall management cards against CRA Class II requirements | $95,000 | 4 weeks |
| **Secure SDLC Post-Acquisition Integration** | Align acquired development workflows with corporate secure coding standards (IEC 62443-4-1) | $135,000 | 6 weeks |
| **OCP S.A.F.E. Compliance Pre-Audit** | Pre-certification review of physical security appliances against open hardware standards | $110,000 | 5 weeks |

---

### 6.4 Sources & Citations
1.  Palo Alto Networks, Inc.. (2025). *Consolidated Financial Statements & Annual Report 2024*.
...
---
*END OF PROFILE - PALO ALTO NETWORKS - 6 PAGES*
