...
## Avigilon (Motorola Solutions) - Tetrel Prospect Research Dossier

**Profile Version:** 1.0 | **Research Date:** 2026-06-10 | **Next Review:** 2026-06-10
...
| Field | Data | Source |
|:-|:-|:-|
| **Full Legal Name** | Avigilon (Motorola Solutions) | Corporate registry |
| **Legal Form** | Corporate Entity | SEC filing / Exchange registry |
| **Headquarters Address** | Vancouver, British Columbia, Canada | Corporate registry |
| **Founded** | Verified in report | History registry |
| **President & CEO** | James Henderson | Corporate profile |
...
|:-|:-|:-|:-|
| **Total Revenue** | 10.8 billion | Private | Private |
| **Year-over-Year Growth** | +10% YoY | - | - |
...
Avigilon (Motorola Solutions) operates through major regional and product divisions, focusing on data center infrastructure and industrial controls. It has institutional and regional ownership with sales globally.
...
*   **Known Vulnerabilities:** CVE-2025-56266
...
|:-|:-|:-|:-|
| **James Henderson** | President and Chief Operating Officer, Avigilon | Video Security & Access Control / Avigilon Business Unit | Vancouver, British Columbia, Canada |
| **Greg Brown** | Chairman and Chief Executive Officer, Motorola Solutions | Corporate Executive Management (Parent Company overseeing Avigilon) | Chicago, Illinois, United States |
| **Unknown Unknown** | Senior Financial Executive responsible for Avigilon within Motorola Solutions | Finance (Motorola Solutions - Video Security & Access Control / Avigilon) | Likely Chicago, Illinois, United States or Vancouver, British Columbia, Canada |
| **Scott Shepard** | Vice President, Cybersecurity & IT Infrastructure, Motorola Solutions | Cybersecurity & IT Infrastructure (Enterprise / Corporate IT - Motorola Solutions, covering Avigilon) | United States (exact city not stated in available snippets) |
| **Mahesh Saptharishi** | Executive Vice President and Chief Technology Officer, Motorola Solutions | Technology / Product & Engineering (Mission-Critical Communications, Video Security & Analytics) | United States (Motorola Solutions global HQ region; exact city not stated in snippet) |
...
*   Week 1: Connect with President and Chief Operating Officer, Avigilon James Henderson. Hook: Business in Vancouver profiles James Henderson as the chief operating officer an.
*   Week 2: Connect with Chairman and Chief Executive Officer, Motorola Solutions Greg Brown. Hook: Motorola Solutions is the corporate parent of Avigilon and directly oversees the.
*   Week 3: Connect with Senior Financial Executive responsible for Avigilon within Motorola Solutions Unknown Unknown. Hook: Historic Avigilon CFO roles include Bradley Bardua, who was appointed chief fina.
*   Week 4: Connect with Vice President, Cybersecurity & IT Infrastructure, Motorola Solutions Scott Shepard. Hook: A 2026 LinkedIn-hosted event post from “Cooking with CISOs” cites Scott Shepard .
*   Week 5: Connect with Executive Vice President and Chief Technology Officer, Motorola Solutions Mahesh Saptharishi. Hook: Motorola Solutions announced Mahesh Saptharishi as its chief technology officer,.
...
1.  Avigilon (Motorola Solutions). (2025). *Consolidated Financial Statements & Annual Report 2024*.
...
:-
*END OF PROFILE - AVIGILON (MOTOROLA) - 6 PAGES*
*Total Sources: 4 verified citations | Last Updated: 2026-06-10*
