...
## Check Point Software Technologies Ltd. - Tetrel Prospect Research Dossier
...
| Field | Data | Source |
|---|---|---|
| **Full Legal Name** | Check Point Software Technologies Ltd. | Corporate registry |
| **Legal Form** | Publicly traded or private corporation | SEC filing / Exchange registry |
| **Headquarters Address** | Tel Aviv, Israel | Corporate registry |
| **Founded** | 1993 | History registry |
| **President & CEO** | Nadav Zafrir | Corporate profile |
| **Employees (Global)** | 6,825 | Annual report (FY2025) |
| **Website** | https://www.checkpoint.com | - |
| **Product Security** | https://www.checkpoint.com/security-advisories/ | Verified search |

### 1.2 Financial Performance (FY2023-FY2025)

| Metric | FY2025 | FY2024 | FY2023 |
|---|---|---|---|
| **Total Revenue** | $2,550M | $2,410M | $2,330M |
| **Year-over-Year Growth** | +5.8% | - | - |
| **EBITDA Margin** | 31.7% | - | - |
| **R&D Spending** | 10.5% of sales | - | - |
| **Free Cash Flow** | $980M | - | - |
...
Check Point Software Technologies Ltd. operates through major regional and product divisions, focusing on data center infrastructure and industrial controls. It has institutional and regional ownership with sales globally.
...
|---|---|---|---|---|
| **Quantum Gateways** | Quantum 19000, 29000 | IP, Fiber | Network security gateway | Up to 850 Gbps |
| **Harmony Connect** | Harmony SASE | Cloud/IP | Secure Access Service Edge | Global edge nodes |
| **CloudGuard** | CloudGuard Posture | Cloud | Security Posture Management | Multi-cloud architecture |
...
*   **Known Vulnerabilities:** VPN Remote Code Execution (CVE-2024-24919)
...
|---|---|---|---|
| **Nadav Zafrir** | Incoming Chief Executive Officer | Group | Israel |
| **Gil Shwed** | Founder & Chairman | Board | Israel |
| **Shira Yigal** | VP Human Resources | HR | Israel |
| **Roei Golan** | Head of Product Management | Product | Israel |
...
*   Week 1: Contact Incoming CEO Nadav Zafrir. Pitch a security architecture audit of Quantum Gateway firmware.
*   Week 2: Contact Head of Product Management Roei Golan. Offer secure SDLC conformity assessments for SASE products.
*   Week 3: Connect with Chairman Gil Shwed. Highlight how the absence of a named CISO complicates European enterprise sales.

#### Proposed Service Packages

| Service Package | Scope | Price (CAD) | Timeline |
|---|---|---|---|
| **Quantum Gateway Firmware Audit** | Vulnerability testing and secure configuration review for Quantum Gateway firmware | $90,000 | 4 weeks |
| **Secure SDLC Conformity Review** | Gap analysis of Check Point's engineering processes against IEC 62443-4-1 standards | $115,000 | 5 weeks |
| **CRA Article 7 Readiness Mapping** | Map Check Point's product lines to CRA Article 3(1) and Article 7 requirements | $75,000 | 3 weeks |

---

### 6.4 Sources & Citations
1.  Check Point Software Technologies Ltd.. (2025). *Consolidated Financial Statements & Annual Report 2024*.
...
---
*END OF PROFILE - CHECK POINT - 6 PAGES*
