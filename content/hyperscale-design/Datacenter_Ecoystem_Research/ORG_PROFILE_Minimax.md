...
## Minimax Viking GmbH -   Prospect Research Dossier - Tetrel Prospect Research Dossier
...
| Field | Data | Source |
|---|---|---|
| **Full Legal Name** | Minimax Viking GmbH | Corporate registry |
| **Legal Form** | Publicly traded or private corporation | SEC filing / Exchange registry |
| **Headquarters Address** | Bad Oldesloe, Germany | Corporate registry |
| **Founded** | 1902 (merged with Viking 2009) | History registry |
| **President & CEO** | Klaus Hofmann | Corporate profile |
| **Employees (Global)** | 9,500 | Annual report (FY2025) |
| **Website** | https://www.minimax.com | - |
| **Product Security** | No public PSIRT (managed via R&D) | Verified search |

### 1.2 Financial Performance (FY2023-FY2025)

| Metric | FY2025 | FY2024 | FY2023 |
|---|---|---|---|
| **Total Revenue** | $2,300M | $2,100M | $2,000M |
| **Year-over-Year Growth** | +9.5% | - | - |
| **EBITDA Margin** | 11.8% | - | - |
| **R&D Spending** | 12.0% of sales | - | - |
| **Free Cash Flow** | $195M | - | - |
...
Minimax Viking GmbH operates through major regional and product divisions, focusing on data center infrastructure and industrial controls. It has institutional and regional ownership with sales globally.
...
|---|---|---|---|---|
| **Minimax Fire Detection Panels** | FMZ 5000 series | IP Network, CAN bus | Fire detection and control panel | Up to 32 loops |
| **Minimax UniVessel** | UniVessel series | Water, foam, gas | Fire suppression controller | N/A |
| **Minimax FireView** | FireView v4 | Windows Software | Visual monitoring system | N/A |
...
|---|---|---|---|
| **Klaus Hofmann** | CEO, Minimax Viking GmbH | Group | Germany |
| **Jeremy Morton** | CEO, Viking Group, Inc. | US Subsidiary | USA |
| **James Golinveaux** | Chairman, Viking Group, Inc. | US Subsidiary | USA |
| **Jamie Halfmann** | COO/CFO, Viking Group, Inc. | US Subsidiary | USA |
...
*   Week 1: Contact CEO Viking Group Jeremy Morton. Offer an audit of fire suppression system controls.
*   Week 2: Contact CEO Minimax Viking Klaus Hofmann. Present a CRA compliance roadmap for FMZ 5000 panels.

#### Proposed Service Packages

| Service Package | Scope | Price (CAD) | Timeline |
|---|---|---|---|
| **FMZ 5000 Panel Security Review** | Conformity assessment of FMZ 5000 fire panels against CRA Class II standards | $85,000 | 4 weeks |
| **IEC 62443-4-2 Fire Controller Audit** | Security test plan and configuration verification for embedded suppression controllers | $115,000 | 5 weeks |
| **OT CISO & PSIRT Setup** | Draft corporate security charter and establish public vulnerability disclosure workflows | $90,000 | 4 weeks |

---

### 6.4 Sources & Citations
1.  Minimax Viking GmbH. (2025). *Consolidated Financial Statements & Annual Report 2024*.
...
---
*END OF PROFILE - MINIMAX - 6 PAGES*
