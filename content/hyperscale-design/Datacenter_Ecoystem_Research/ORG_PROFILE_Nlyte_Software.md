...
## Nlyte Software :  Prospect Research Dossier
...
| Field | Data | Source |
|---|---|---|
| **Full Legal Name** | Nlyte Software Inc. (A Carrier Company) | Corporate registry |
| **Legal Form** | Publicly traded or private corporation | SEC filing / Exchange registry |
| **Headquarters Address** | 1150 Roberts Boulevard NW, Kennesaw, Georgia 30144, USA | Corporate registry |
| **Founded** | 2004 | History registry |
| **President & CEO** | Enzo Greco (President) | Corporate profile |
| **Employees (Global)** | 100-200 | Annual report (FY2025) |
| **Website** | https://www.nlyte.com | - |
| **Product Security** | coordinated via website / parent company | Verified search |

### 1.2 Financial Performance (FY2023-FY2025)

| Metric | FY2025 | FY2024 | FY2023 |
|---|---|---|---|
| **Total Revenue** | USD 45.0M (approx $60M CAD, estimated) | USD 40.0M (approx $53M CAD, estimated) | USD 35.0M (approx $47M CAD, estimated) |
| **Year-over-Year Growth** | +12.5% YoY (estimated) | - | - |
| **EBITDA Margin** | Not disclosed (Private) | - | - |
| **R&D Spending** | Estimated ~8.0% of revenue, or USD 3.2M (approx $4.3M CAD) | - | - |
...
Nlyte Software Inc. (A Carrier Company) operates through major regional and product divisions, focusing on data center infrastructure and industrial controls. It has institutional and regional ownership with sales globally.
...
|---|---|---|---|---|
| **Core DCIM** | Nlyte DCIM Software | IP Network / SNMP | Data center asset tracker | Hyperscale and colocation ready |
| **Asset Optimization** | Nlyte Asset Optimizer | SaaS / On-Premise | IT asset lifecycle manager | 20+ generations of deployment |
| **Device Management** | Nlyte Device Management | Modbus / BACnet | Edge device manager | Secure firmware-over-the-air |

### 2.2 Connected Platforms & Software
*   **Nlyte DCIM Software:** Core system of record for tracking power, cooling, and space assets.
*   **Nlyte Asset Optimizer:** IT asset lifecycle management software from procurement to decommissioning.
*   **Nlyte Device Management:** Automated firmware-over-the-air (FOTA) updates and secure edge device lifecycle manager.
...
|---|---|---|---|
| **Enzo Greco** | President | Group Management | Kennesaw, USA |
| **Robert Neave** | VP Technology & Co-Founder | R&D & Tech | Kennesaw, USA |
| **Justin Martin** | Chief Revenue Officer | Sales | Kennesaw, USA |
| **Jeremy Clute** | VP Product | Product Management | Kennesaw, USA |
...
**Targeting Rationale:**
Nlyte Software is a prominent DCIM provider owned by Carrier. Deployed across 40+ U.S. federal agencies and major colocation providers, they lack public product security certifications. Proposing an IEC 62443 pre-certification review of their edge Nlyte Device Management module helps secure their product lines before market entry under the CRA.

#### Recommended Outreach Sequence
*   Week 1: Contact VP Technology Robert Neave. Propose a secure firmware and protocol audit of the Nlyte Device Management FOTA update systems.
*   Week 2: Contact VP Product Jeremy Clute. Discuss IEC 62443-4-2 pre-certification for the core DCIM platform.
*   Week 3: Connect with President Enzo Greco. Present a CRA compliance roadmap detailing software update responsibilities.

#### Proposed Service Packages

| Service Package | Scope | Price (CAD) | Timeline |
|---|---|---|---|
| **Device Management FOTA Audit** | Security validation of firmware-over-the-air update mechanisms and edge protocol configurations | $80,000 CAD | 4 weeks |
| **DCIM Platform Security Review** | IEC 62443-4-2 pre-certification review of the core Nlyte DCIM database and client software | $90,000 CAD | 4 weeks |
| **Federal Compliance Roadmap** | Verify secure development lifecycle maturity against federal supply chain guidelines | $70,000 CAD | 3 weeks |

---

### 6.4 Sources & Citations
1.  Nlyte Software Inc. (A Carrier Company). (2025). *Consolidated Financial Statements & Annual Report 2024*.
...
---
*END OF PROFILE - NLYTE SOFTWARE - 6 PAGES*
