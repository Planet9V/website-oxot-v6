...
## Modine Manufacturing Company (Airedale) -  Prospect Research Dossier
...
| **Headquarters Address** | Racine, Wisconsin, USA (Airedale based in Leeds, UK) | Corporate registry |
| **Founded** | 1916 | History registry |
| **President & CEO** | Neil D. Brinker | Corporate profile |
| **Employees (Global)** | 11,000 | Annual report (FY2025) |
| **Website** | https://www.modine.com | - |
| **Product Security** | No public PSIRT (managed via IT/Legal) | Verified search |

### 1.2 Financial Performance (FY2023-FY2025)

| Metric | FY2025 | FY2024 | FY2023 |
|---|---|---|---|
| **Total Revenue** | $2,650M | $2,400M | $2,300M |
| **Year-over-Year Growth** | +10.4% | - | - |
| **EBITDA Margin** | 12.8% | - | - |
| **R&D Spending** | 2.9% of sales | - | - |
| **Free Cash Flow** | $180M | - | - |
...
|---|---|---|---|---|
| **Airedale SmartCool** | Chillers & CRACs | Water/refrigerant | Precision cooling | 15 to 150 kW |
| **Airedale AireFlow** | Indirect adiabatic cooling | Air/water | Hyperscale cooling | 100 to 400 kW |
| **Modine Control System** | MAP controller | Embedded controls | Microcontroller base | N/A |
...
|---|---|---|---|
| **Neil Brinker** | President & CEO | Group | USA |
| **Eric McGinnis** | President, Climate Solutions | Climate Solutions | USA |
| **Mick Lucareli** | EVP & CFO | Group | USA |
...
*   Week 1: Contact President of Climate Solutions Eric McGinnis. Offer an audit of connected cooling systems.
*   Week 2: Contact CEO Neil Brinker. Present a CRA compliance roadmap for Airedale controllers.
*   Week 3: Connect with CFO Mick Lucareli. Present financial risk assessment under the new EU CRA.

#### Proposed Service Packages

| Service Package | Scope | Price (CAD) | Timeline |
|---|---|---|---|
| **Airedale Controller Security Audit** | Conformity assessment of Airedale MAP controllers against CRA Class II standards | $85,000 | 4 weeks |
| **CRA Article 7 Readiness Review** | Map Modine Climate Solutions digital portfolio to CRA compliance requirements | $70,000 | 3 weeks |
| **IEC 62443-4-1 Secure SDLC Setup** | Establish secure software development lifecycle for cooling controller team | $115,000 | 6 weeks |
| **SBOM Automation Pipeline** | Automate CycloneDX SBOM generation for Airedale firmware and cloud platforms | $80,000 | 4 weeks |
...
---
*END OF PROFILE - MODINE AIREDALE - 6 PAGES*
