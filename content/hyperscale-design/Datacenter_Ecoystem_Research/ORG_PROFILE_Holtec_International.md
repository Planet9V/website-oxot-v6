...
## Holtec International :   Prospect Research Dossier
...
| Field | Data | Source |
|---|---|---|
| **Full Legal Name** | Holtec International | Corporate registry |
| **Legal Form** | Publicly traded or private corporation | SEC filing / Exchange registry |
| **Headquarters Address** | Jupiter, Florida, USA | Corporate registry |
| **Founded** | 1986 | History registry |
| **President & CEO** | Dr. Kris Singh | Corporate profile |
| **Employees (Global)** | ~800 | Annual report (FY2025) |
| **Website** | https://www.holtecinternational.com | - |
| **Product Security** | security@holtec.com | Verified search |

### 1.2 Financial Performance (FY2023-FY2025)

| Metric | FY2025 | FY2024 | FY2023 |
|---|---|---|---|
| **Total Revenue** | USD 650M (approx $975M CAD, estimated) | USD 500M (approx $750M CAD) | USD 480M (approx $720M CAD, estimated) |
| **Year-over-Year Growth** | +4.0% YoY (estimated) | - | - |
| **EBITDA Margin** | Operating Profit USD 80M (approx $120M CAD, ~16% margin) | - | - |
| **R&D Spending** | Estimated ~10% of revenue, or USD 50M (approx $75M CAD) | - | - |
...
Holtec International operates through major regional and product divisions, focusing on data center infrastructure and industrial controls. It has institutional and regional ownership with sales globally.
...
|---|---|---|---|---|
| **HI-STORM Storage Casks** | HI-STORM 100 / UMAX | Passive / Subterranean | Spent nuclear fuel dry storage system | Deployed at 118 nuclear plants |
| **SMR-300 Reactor** | SMR-300 | Digital I&C | 300 MWe small modular reactor system | Hyundai E&C development partner |
| **HI-STAR Transport Casks** | HI-STAR 100 / 180 | Transport Cask | Shielded spent fuel transport cask | Operational worldwide |

### 2.2 Connected Platforms & Software
*   **HI-STORM:** Spent fuel dry storage cask systems (UMAX subterranean variants).
*   **HI-STAR / HI-TRAC:** Shielded transport and heavy handling casks.
*   **SMR-300:** Advanced 300 MWe small modular reactor design under development.
...
*   **Known Vulnerabilities:** None publicly identified in research window.
...
|---|---|---|---|
| **Kris Singh** | CEO, Chairman, President | Group Management | Jupiter, USA |
| **Kelly Trice** | President | Operations | Jupiter, USA |
| **Thomas Howe** | Chief Financial Officer | Finance | Jupiter, USA |
| **Richard Burroni** | Chief Nuclear Officer | Nuclear Operations | Jupiter, USA |
...
**Targeting Rationale:**
Holtec is a major nuclear equipment vendor preparing for an IPO and SMR commercialization. Their SMR-300 digital instrumentation and control (I&C) systems must comply with NRC 10 CFR 73.54 and NERC CIP. Proposing a Critical Digital Asset (CDA) scoping review to CEO Dr. Kris Singh and CNO Richard Burroni represents a high-priority opening.

#### Recommended Outreach Sequence
*   Week 1: Contact Chief Nuclear Officer Richard Burroni. Propose a digital I&C cybersecurity plan review for the SMR-300 platform against NRC 10 CFR 73.54.
*   Week 2: Contact President Kelly Trice. Offer a supply chain security audit and SBOM validation for decommissioning control networks.
*   Week 3: Connect with CFO Thomas P. Howe. Detail a pre-IPO cyber risk and regulatory compliance audit for SMR licensing programs.

#### Proposed Service Packages

| Service Package | Scope | Price (CAD) | Timeline |
|---|---|---|---|
| **SMR Digital I&C Cyber Review** | Critical Digital Asset (CDA) boundary definition and cybersecurity plan support for SMR-300 | $160,000 CAD | 6 weeks |
| **Decommissioning Network Audit** | Security and network segmentation review of decommissioning process networks and SCADA | $90,000 CAD | 4 weeks |
| **Nuclear Supply Chain SBOM** | Set up automated SBOM validation tools for third-party reactor component software | $85,000 CAD | 4 weeks |

---

### 6.4 Sources & Citations
1.  Holtec International. (2025). *Consolidated Financial Statements & Annual Report 2024*.
...
---
*END OF PROFILE - HOLTEC INTERNATIONAL - 6 PAGES*
