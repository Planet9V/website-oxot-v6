...
## Wiwynn Corporation - Prospect Research Dossier
...
| Field | Data | Source |
|:-|:-|:-|
| **Full Legal Name** | Wiwynn Corporation (緯穎科技服務股份有限公司) | Corporate registry |
| **Legal Form** | Publicly traded or private corporation | SEC filing / Exchange registry |
| **Headquarters Address** | New Taipei City, Taiwan | Corporate registry |
| **Founded** | 2012 | History registry |
| **President & CEO** | William Lin | Corporate profile |
| **Employees (Global)** | 415 core, 1,500+ group | Annual report (FY2025) |
...
|:-|:-|:-|:-|
| **Total Revenue** | NT$950.66B (approx $42.8B CAD) | NT$360.54B (approx $16.2B CAD) | NT$242.00B (approx $10.9B CAD) |
| **Year-over-Year Growth** | +163.7% | - | - |
...
Wiwynn Corporation (緯穎科技服務股份有限公司) operates through major regional and product divisions, focusing on data center infrastructure and industrial controls. It has institutional and regional ownership with sales globally.
...
|:-|:-|:-|:-|:-|
| **SV500G3 GPU Server** | SV500G3 | IP Network, PCIe Gen5 | GPU-intensive compute server | Supports 8x GPUs |
| **SV302A/G3 Cloud Server** | SV302A / SV302G3 | IP Network, OCP 3.0 | High-density cloud server | 2-node 1U chassis |
| **SV7000G4 Storage** | SV7000G4 | NVMe-oF, SAS | High-density object storage | 21-inch Grand Canyon chassis |
...
|:-|:-|:-|:-|
| **William Lin** | President & CEO | Group | Taiwan |
| **Emily Hong** | Chair & Founder | Board | Taiwan |
| **Christopher Huang** | Vice President | Operations | Taiwan |
...
*   Week 1: Contact President & CEO William Lin. Pitch an OCP S.A.F.E. pre-certification review of upcoming SV500G3 GPU server platforms.
*   Week 2: Contact VP Christopher Huang. Discuss custom BMC secure boot and firmware threat modeling.
*   Week 3: Connect with Chair Emily Hong. Highlight board-level Cyber Resilience Act Class II compliance risks.

#### Proposed Service Packages

| Service Package | Scope | Price (CAD) | Timeline |
|:-|:-|:-|:-|
| **SV500G3 Firmware Security Audit** | Secure code review and threat model of central BMC software stacks in SV500G3 servers | $115,000 | 5 weeks |
| **OCP S.A.F.E. Compliance Prep** | Audit GPU server motherboard design against Open Compute Project secure hardware standards | $95,000 | 4 weeks |
| **CRA Class II Product Compliance Prep** | Conformity assessment of connected server lines under EU Cyber Resilience Act Class II certification gates | $110,000 | 5 weeks |

:-

### 6.4 Sources & Citations
1.  Wiwynn Corporation (緯穎科技服務股份有限公司). (2025). *Consolidated Financial Statements & Annual Report 2024*.
