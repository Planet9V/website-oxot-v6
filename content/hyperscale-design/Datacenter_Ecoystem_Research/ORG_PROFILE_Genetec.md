...
## Genetec Inc. -   Prospect Research Dossier
...
| Field | Data | Source |
|---|---|---|
| **Full Legal Name** | Genetec Inc. | Corporate registry |
| **Legal Form** | Publicly traded or private corporation | SEC filing / Exchange registry |
| **Headquarters Address** | Saint-Laurent, Quebec, Canada | Corporate registry |
| **Founded** | 1997 | History registry |
| **President & CEO** | Pierre Racz | Corporate profile |
| **Employees (Global)** | 2,000 | Annual report (FY2025) |
| **Website** | https://www.genetec.com | - |
| **Product Security** | security@genetec.com | Verified search |

### 1.2 Financial Performance (FY2023-FY2025)

| Metric | FY2025 | FY2024 | FY2023 |
|---|---|---|---|
| **Total Revenue** | $410M | $380M | $350M |
...
Genetec Inc. operates through major regional and product divisions, focusing on data center infrastructure and industrial controls. It has institutional and regional ownership with sales globally.
...
|---|---|---|---|---|
| **Genetec Security Center** | Omnicast, Synergis | IP network | Unified security platform | Up to 50,000 cameras |
| **Genetec Synergis Cloud Link** | Synergis Cloud Link | IP network | Access control controller | Up to 64 readers |
| **Genetec ClearID** | Cloud SaaS | Web service | Identity & access management | N/A |
...
|---|---|---|---|
| **Pierre Racz** | President, CEO & Founder | Group | Canada |
| **Guy Chenard** | Chief Commercial Officer | Sales | Canada |
| **Christian Morin** | VP Product Engineering | Engineering | Canada |
...
*   Week 1: Contact CCO Guy Chenard. Offer a pre-audit for hyperscaler security RFPs.
*   Week 2: Contact VP Product Engineering Christian Morin. Offer IEC 62443-4-2 readiness review.
*   Week 3: Connect with CEO Pierre Racz. Discuss cryptography and CRA Class II conformity.

#### Proposed Service Packages

| Service Package | Scope | Price (CAD) | Timeline |
|---|---|---|---|
| **Synergis Cloud Link 62443 Audit** | Conformity assessment and gap analysis of Synergis Cloud Link against IEC 62443-4-2 SL-2 | $110,000 | 5 weeks |
| **CRA Class II Product Review** | Verify secure boot and firmware validation procedures against CRA requirements | $90,000 | 4 weeks |
| **IEC 62443-4-1 Process Certification** | Secure software engineering development process audit and training | $135,000 | 6 weeks |

---

### 6.4 Sources & Citations
1.  Genetec Inc.. (2025). *Consolidated Financial Statements & Annual Report 2024*.
...
---
*END OF PROFILE - GENETEC - 6 PAGES*
