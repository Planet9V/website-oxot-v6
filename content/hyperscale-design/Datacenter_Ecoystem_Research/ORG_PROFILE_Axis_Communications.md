...
## Axis Communications AB - Tetrel Prospect Research Dossier - Tetrel Prospect Research Dossier
...
| Field | Data | Source |
|---|---|---|
| **Full Legal Name** | Axis Communications AB (Subsidiary of Canon) | Corporate registry |
| **Legal Form** | Publicly traded or private corporation | SEC filing / Exchange registry |
| **Headquarters Address** | Lund, Sweden | Corporate registry |
| **Founded** | 1984 | History registry |
| **President & CEO** | Ray Mauritsson | Corporate profile |
| **Employees (Global)** | 4,200 | Annual report (FY2025) |
| **Website** | https://www.axis.com | - |
| **Product Security** | security@axis.com | Verified search |

### 1.2 Financial Performance (FY2023-FY2025)

| Metric | FY2025 | FY2024 | FY2023 |
|---|---|---|---|
| **Total Revenue** | $1,750M | $1,600M | $1,500M |
| **Year-over-Year Growth** | +9.4% | - | - |
| **EBITDA Margin** | 18.2% | - | - |
| **R&D Spending** | 15.0% of sales | - | - |
| **Free Cash Flow** | $185M | - | - |
...
Axis Communications AB (Subsidiary of Canon) operates through major regional and product divisions, focusing on data center infrastructure and industrial controls. It has institutional and regional ownership with sales globally.
...
|---|---|---|---|---|
| **Axis IP Cameras** | Q-series, P-series, M-series | IP Network | Network surveillance camera | N/A |
| **Axis Network Door Controllers** | A1001, A1601 | IP Network | Access control controller | Up to 32 readers |
| **Axis Camera Station** | ACS v5 | Windows/Linux | Video management software | N/A |
...
*   **Known Vulnerabilities:** CVE-2023-21415 (AXIS OS command injection CVSS 8.8)
...
|---|---|---|---|
| **Ray Mauritsson** | President & CEO | Group | Sweden |
| **Johan Paulsson** | Chief Technology Officer | R&D | Sweden |
| **Jeanette Skjelmose** | Chief Security & Compliance Officer | Security & Compliance | Sweden |
| **Jonas Hansson** | Chief Information Officer | IT | Sweden |
...
*   Week 1: Contact CSCO Jeanette Skjelmose. Offer an audit of the Axis Security Development Model (ASDM).
*   Week 2: Contact CTO Johan Paulsson. Pitch secure hardware design for next-gen ARTPEC silicon.

#### Proposed Service Packages

| Service Package | Scope | Price (CAD) | Timeline |
|---|---|---|---|
| **ASDM Secure Process Audit** | Evaluate the Axis Security Development Model against IEC 62443-4-1 standards | $95,000 | 4 weeks |
| **ARTPEC Silicon Security Review** | Security architecture audit for next-generation ARTPEC-9 and ARTPEC-10 processors | $135,000 | 6 weeks |
| **AXIS OS CRA Conformity Mapping** | Conformity assessment of AXIS OS and connected devices under the EU CRA | $85,000 | 4 weeks |

---

### 6.4 Sources & Citations
1.  Axis Communications AB (Subsidiary of Canon). (2025). *Consolidated Financial Statements & Annual Report 2024*.
...
---
*END OF PROFILE - AXIS COMMUNICATIONS - 6 PAGES*
