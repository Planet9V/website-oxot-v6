...
## Fike Corporation - Tetrel Prospect Research Dossier
...
| Field | Data | Source |
|---|---|---|
| **Full Legal Name** | Fike Corporation | Corporate registry |
| **Legal Form** | Publicly traded or private corporation | SEC filing / Exchange registry |
| **Headquarters Address** | Blue Springs, Missouri, USA | Corporate registry |
| **Founded** | 1945 | History registry |
| **President & CEO** | Brad Batz | Corporate profile |
| **Employees (Global)** | 1,000 | Annual report (FY2025) |
| **Website** | https://www.fike.com | - |
| **Product Security** | No public PSIRT (vulnerability routing via IT) | Verified search |

### 1.2 Financial Performance (FY2023-FY2025)

| Metric | FY2025 | FY2024 | FY2023 |
|---|---|---|---|
| **Total Revenue** | $360M | $338M | $320M |
| **Year-over-Year Growth** | +6.5% | - | - |
| **EBITDA Margin** | 11.5% | - | - |
| **R&D Spending** | 2.8% of sales | - | - |
| **Free Cash Flow** | $24M | - | - |
...
Fike Corporation operates through major regional and product divisions, focusing on data center infrastructure and industrial controls. It has institutional and regional ownership with sales globally.
...
|---|---|---|---|---|
| **Fike CyberCat** | CyberCat 1016, 254 | IP Network, Modbus | Fire alarm control system | Up to 1016 addressable devices |
| **Fike Cheetah Xi** | Cheetah Xi 50 | Serial, BACnet | Fire suppression release | SIL 2 certified |
| **Fike Fanno** | Fanno isolation valve | Mechanical, CANbus | Explosion protection valve | Up to 1200 mm diameter |
...
|---|---|---|---|
| **Brad Batz** | President & CEO | Group | USA |
| **Josh Batz** | EVP & President Sales & Marketing | Sales | USA |
| **Richard D. Winston, Jr.** | EVP, General Counsel & Secretary | Legal | USA |
...
*   Week 1: Contact CEO Brad Batz. Present a CRA compliance roadmap for connected fire alarm panels.
*   Week 2: Contact EVP Josh Batz. Present a secure development lifecycle gap analysis.
*   Week 3: Connect with General Counsel Richard D. Winston, Jr. Present financial and regulatory compliance risks.

#### Proposed Service Packages

| Service Package | Scope | Price (CAD) | Timeline |
|---|---|---|---|
| **Fire Control Panel Security Audit** | Conformity assessment of Fike's connected fire panels against CRA Class I/II requirements | $85,000 | 4 weeks |
| **Secure SDLC Framework Setup** | Establish secure software development processes for Fike connected product lines | $115,000 | 6 weeks |
| **CRA Article 3(1) Compliance Assessment** | Map Fike's digital safety portfolio to CRA and NIS2 requirements | $70,000 | 3 weeks |

---

### 6.4 Sources & Citations
1.  Fike Corporation. (2025). *Consolidated Financial Statements & Annual Report 2024*.
...
---
*END OF PROFILE - FIKE CORPORATION - 6 PAGES*
