...
## Anybus (HMS) : Tetrel Prospect Research Dossier
...
| Field | Data | Source |
|---|---|---|
| **Full Legal Name** | HMS Networks AB (publ) (Anybus) | Corporate registry |
| **Legal Form** | Publicly traded or private corporation | SEC filing / Exchange registry |
| **Headquarters Address** | Stationsgatan 37, Halmstad, Sweden | Corporate registry |
| **Founded** | 1988 | History registry |
| **President & CEO** | Staffan Dahlström | Corporate profile |
| **Employees (Global)** | ~1,100 | Annual report (FY2025) |
| **Website** | https://www.hms-networks.com | - |
| **Product Security** | psirt@hms-networks.com (coordinated via hms-networks.com/cybersecurity) | Verified search |

### 1.2 Financial Performance (FY2023-FY2025)

| Metric | FY2025 | FY2024 | FY2023 |
|---|---|---|---|
| **Total Revenue** | EUR 280M (approx $420M CAD, estimated) | EUR 268M (approx $402M CAD) | EUR 250M (approx $375M CAD, estimated) |
| **Year-over-Year Growth** | +7.2% YoY (estimated) | - | - |
| **EBITDA Margin** | Operating Result EUR 54M (20% margin, approx $81M CAD) | - | - |
| **R&D Spending** | Estimated ~8% of revenue, or EUR 21.4M (approx $32M CAD) | - | - |
| **Free Cash Flow** | Operating cash flow EUR 45M (approx $67M CAD) | - | - |

*Source: Consolidated financial statements. Equivalent CAD values calculated at 1.50 EUR/CAD or historical currency exchange rates. Debt-to-asset ratio is managed to conservative limits.*

### 1.3 Business Ownership & Structure
HMS Networks AB (publ) (Anybus) operates through major regional and product divisions, focusing on data center infrastructure and industrial controls. It has institutional and regional ownership with sales globally.
...
|---|---|---|---|---|
| **Anybus X-Gateway** | AB7504-F / AB7505-F | Ethernet / PROFINET | Protocol converter | 250+ protocol combinations |
| **Anybus CompactCom** | CompactCom B40 / C40 | Embedded Interface | OEM network interface | Multi-protocol support |
| **Anybus Communicator** | Communicator IIoT | Gateway / Wireless | Industrial gate controller | CRA-ready firmware |

### 2.2 Connected Platforms & Software
*   **Anybus X-Gateway:** Protocol converters enabling fieldbus-to-Ethernet translation (AB7504-F, AB7505-F, AB9001).
*   **Anybus CompactCom:** Embedded network interfaces for OEM device integration (CompactCom B40, C40).
*   **Anybus Communicator:** Standalone gateway products for connecting devices to major networks. CRA-ready versions shipping spring 2026.
...
*   **Known Vulnerabilities:** CVE-2024-6558 (unauthenticated configuration access CVSS 7.5), CVE-2025-0432 (buffer overflow in Communicator CVSS 8.2)
...
|---|---|---|---|
| **Staffan Dahlström** | CEO & President | Group Management | Halmstad, Sweden |
| **Joakim Nideborn** | CFO & Deputy CEO | Finance | Halmstad, Sweden |
| **Bartek Stelmasiak Candell** | SVP Industrial Network Technology | Anybus | Halmstad, Sweden |
| **Fredrik Brynolf** | Gateway Business Line Director | Anybus | Halmstad, Sweden |
...
**Targeting Rationale:**
Anybus is shipping CRA-ready versions of its Communicator, but their legacy uncertified communicator and gateway product lines have major exposure. Proposing an IEC 62443-4-2 component gap audit to SVP Bartek Stelmasiak Candell is an excellent high-credibility entry point.

#### Recommended Outreach Sequence
*   Week 1: Contact SVP Industrial Network Technology Bartek Stelmasiak Candell. Offer an audit of the Anybus X-Gateway firmware against IEC 62443-4-2 standards.
*   Week 2: Contact Gateway Director Fredrik Brynolf. Present a compliance roadmap for legacy communicator lines under the Cyber Resilience Act.
*   Week 3: Connect with CFO Joakim Nideborn. Present a financial risk assessment focusing on uncertified gateway lines in European markets.

#### Proposed Service Packages

| Service Package | Scope | Price (CAD) | Timeline |
|---|---|---|---|
| **Anybus Gateway Firmware Audit** | Audit of core gateway firmware stacks against IEC 62443-4-2 SL-2 requirements | $85,000 CAD | 4 weeks |
| **CRA Class II Gap Assessment** | Verify secure update mechanisms and SBOMs for Communicator lines | $75,000 CAD | 4 weeks |
| **Embedded Security Verification** | Code audit of CompactCom modules for secure boot capabilities | $90,000 CAD | 5 weeks |

---

### 6.4 Sources & Citations
1.  HMS Networks AB (publ) (Anybus). (2025). *Consolidated Financial Statements & Annual Report 2024*.
...
---
*END OF PROFILE - ANYBUS (HMS) - 6 PAGES*
