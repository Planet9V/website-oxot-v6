...
## Submer Technologies S.L. - Prospect Research Dossier
...
| Field | Data | Source |
|:-|:-|:-|
| **Full Legal Name** | Submer Technologies S.L. | Corporate registry |
| **Legal Form** | Publicly traded or private corporation | SEC filing / Exchange registry |
| **Headquarters Address** | Barcelona, Spain | Corporate registry |
| **Founded** | 2015 | History registry |
| **President & CEO** | Patrick Smets | Corporate profile |
| **Employees (Global)** | ~155 | Annual report (FY2025) |
| **Website** | https://submer.com | - |
| **Product Security** | Not publicly documented | Verified search |

### 1.2 Financial Performance (FY2023-FY2025)

| Metric | FY2025 | FY2024 | FY2023 |
|:-|:-|:-|:-|
| **Total Revenue** | Private (approx $3.44M CAD, TTM based on FY2022 USD 2.59M) | Private | Private |
| **Year-over-Year Growth** | High growth | - | - |
| **EBITDA Margin** | Not disclosed (Private equity valuation $665M CAD) | - | - |
| **R&D Spending** | Not disclosed | - | - |
| **Free Cash Flow** | Not disclosed (Debt financing $27.68M CAD) | - | - |
...
Submer Technologies S.L. operates through major regional and product divisions, focusing on data center infrastructure and industrial controls. It has institutional and regional ownership with sales globally.
...
|:-|:-|:-|:-|:-|
| **SmartPod EVO** | EVO | Coolant | Liquid Immersion Cooling System | 140+ kW thermal capacity, modular CDU |
| **SmartPod EXO** | EXO | Coolant | High-Density Cooling System | 361 kW max, Dell and Supermicro server integrated |
| **MicroPod** | MicroPod | Coolant | Edge / Outdoor Cooling System | 7 kW, 6U compact unit, IP67 certified |
| **InferX** | InferX | Software | AI Cloud Platform | NVIDIA Cloud Partner, sovereign workloads |
...
|:-|:-|:-|:-|
| **Patrick Smets** | Chief Executive Officer | Group Management | Spain |
| **Daniel Pope** | Founder & CTO | R&D | Spain |
| **Pol Valls Soler** | Founder & CFO | Finance | Spain |
...
*   Week 1: Contact CTO Daniel Pope. Offer a secure configuration audit and threat model validation of the SmartPod controller firmware stack.
*   Week 2: Contact CEO Patrick Smets. Present a CRA conformity gap assessment for their modular and edge cooling systems.
*   Week 3: Connect with CFO Pol Valls Soler. Detail the financial risk exposure of uncertified software under EU regulations.

#### Proposed Service Packages

| Service Package | Scope | Price (CAD) | Timeline |
|:-|:-|:-|:-|
| **SmartPod Firmware Security Review** | Secure code review and binary analysis of SmartPod embedded controller firmware | $95,000 | 4 weeks |
| **Submer Cloud API Audit** | Security validation of Submer Cloud remote monitoring interfaces and API access controls | $85,000 | 4 weeks |
| **CRA Regulatory Gap Assessment** | Conformity assessment of cooling platform controller lines against EU Cyber Resilience Act Class II standards | $70,000 | 3 weeks |

:-

### 6.4 Sources & Citations
1.  Submer Technologies S.L.. (2025). *Consolidated Financial Statements & Annual Report 2024*.
