...
## Sophos : Prospect Research Dossier
...
| Field | Data | Source |
|---|---|---|
| **Full Legal Name** | Sophos Limited | Corporate registry |
| **Legal Form** | Publicly traded or private corporation | SEC filing / Exchange registry |
| **Headquarters Address** | Abingdon Science Park, Abingdon, Oxfordshire, England | Corporate registry |
| **Founded** | 1985 | History registry |
| **President & CEO** | Joe Levy (CEO) | Corporate profile |
| **Employees (Global)** | ~4,000 | Annual report (FY2025) |
| **Website** | https://www.sophos.com | - |
| **Product Security** | bugcrowd.com/sophos (Coordinated disclosure program via Bugcrowd) | Verified search |

### 1.2 Financial Performance (FY2023-FY2025)

| Metric | FY2025 | FY2024 | FY2023 |
|---|---|---|---|
| **Total Revenue** | USD 1.10B (approx $1.46B CAD, estimated) | USD 1.05B (approx $1.40B CAD, estimated) | USD 1.00B (approx $1.33B CAD, estimated) |
| **Year-over-Year Growth** | +4.8% YoY (estimated) | - | - |
| **EBITDA Margin** | Not disclosed (Private company) | - | - |
...
Sophos Limited operates through major regional and product divisions, focusing on data center infrastructure and industrial controls. It has institutional and regional ownership with sales globally.
...
|---|---|---|---|---|
| **Network Security** | XGS Series Next-Gen Firewall (XGS 138 / XGS 3300 / XGS 8500) | Ethernet / Fiber | Hardware next-gen firewall | Dual-processor, Xstream NPU acceleration |
| **Endpoint Protection** | Intercept X / Sophos Central Endpoint | Client Agent | Endpoint security software | AI-driven threat detection and EDR/XDR |
| **Threat Response** | Managed Detection & Response (MDR) / Taegis MDR | SaaS Platform | Threat detection & response service | 24/7 security analyst monitoring |

### 2.2 Connected Platforms & Software
*   **Sophos XGS Firewalls:** Hardware appliances running SFOS with hardware-accelerated threat protection.
*   **Sophos Intercept X:** Leading endpoint protection software with EDR and XDR capabilities.
*   **Sophos Managed Detection and Response:** 24/7 analyst-led threat monitoring and response service.
...
*   **Known Vulnerabilities:** CVE-2025-6704 (Critical Firewall RCE via HA replication), CVE-2025-7624 (Critical SMTP proxy SQLi/RCE), CVE-2024-12727 (Critical Email gateway SQLi/RCE), CVE-2024-12728 (Critical HA SSH auth bypass)
...
|---|---|---|---|
| **Joe Levy** | Chief Executive Officer | Group Management | Abingdon, UK |
| **John Peterson** | Chief Technology Officer | R&D & Tech | Abingdon, UK |
| **Simon Reed** | Chief Security Officer | Information Security | Abingdon, UK |
| **Raja Patel** | President (Product & Marketing) | Product Management | Abingdon, UK |
...
**Targeting Rationale:**
Sophos is a dominant enterprise firewall and endpoint security vendor. However, they have experienced several critical RCE vulnerabilities in their XGS Firewalls (such as CVE-2025-6704 and CVE-2025-7624) that affect high-availability and email processing modules. Proposing a secure architecture and protocol review of their HA replication services provides a high-relevance entry point.

#### Recommended Outreach Sequence
*   Week 1: Contact CTO John Peterson. Propose a secure code review and threat model audit of their XGS HA replication protocols.
*   Week 2: Contact CSO Simon Reed. Offer to validate SFOS email proxy components against secure input handling guidelines.
*   Week 3: Connect with CEO Joe Levy. Discuss CRA compliance mapping and SBOM generation for their firewall operating systems.

#### Proposed Service Packages

| Service Package | Scope | Price (CAD) | Timeline |
|---|---|---|---|
| **XGS Firewall Protocol Review** | Secure code review of high-availability replication and clustering protocols in SFOS | $95,000 CAD | 4 weeks |
| **SMTP Proxy Code Audit** | Vulnerability analysis and input sanitization review of the SMTP filtering and email gateway modules | $85,000 CAD | 4 weeks |
| **CRA Conformity Gap Assessment** | Conformity assessment of firewall firmware and update delivery systems against EU CRA guidelines | $70,000 CAD | 3 weeks |

---

### 6.4 Sources & Citations
1.  Sophos Limited. (2025). *Consolidated Financial Statements & Annual Report 2024*.
