...
## ASPEED Technology - Tetrel Prospect Research Dossier
...
| Field | Data | Source |
|:-|:-|:-|
| **Full Legal Name** | ASPEED Technology Inc. (信驊科技股份有限公司) | Corporate registry |
| **Legal Form** | Publicly traded or private corporation | SEC filing / Exchange registry |
| **Headquarters Address** | Hsinchu City, Taiwan | Corporate registry |
| **Founded** | 2004 | History registry |
| **President & CEO** | Chris Lin | Corporate profile |
| **Employees (Global)** | 150 | Annual report (FY2025) |
| **Website** | https://www.aspeedtech.com | - |
| **Product Security** | No public PSIRT (managed via Engineering/CFO) | Verified search |

### 1.2 Financial Performance (FY2023-FY2025)

| Metric | FY2025 | FY2024 | FY2023 |
|:-|:-|:-|:-|
| **Total Revenue** | NT$9.08B (approx $408.6M CAD) | NT$6.46B (approx $290.7M CAD) | NT$3.13B (approx $140.9M CAD) |
| **Year-over-Year Growth** | +41% YoY in TWD | - | - |
...
ASPEED Technology Inc. (信驊科技股份有限公司) operates through major regional and product divisions, focusing on data center infrastructure and industrial controls. It has institutional and regional ownership with sales globally.
...
|:-|:-|:-|:-|:-|
| **AST2600 BMC SoC** | AST2600 series | Silicon Interface, Firmware | Baseboard management controller SoC | Global market leader in server BMCs |
| **Cupola360 Processor** | AST1250 series | Immersive Video SoC | Multi-image stitching processor | Sigurd remote factory tour system |
| **AST1530 AVoIP SoC** | AST1530 | IP Network, Video | Audio/Video over IP controller | 4K ultra-low latency extension |
...
*   **Known Vulnerabilities:** AST2400/AST2500 virtual media access control vulnerability (CVE-2019-6260, CVSS 9.8)
...
|:-|:-|:-|:-|
| **Chris Lin** | Chairman & President | Group | Taiwan |
| **Hsiang-Chun Wu** | Director & Board Member | Board | Taiwan |
...
*   Week 1: Contact Chairman & President Chris Lin. Propose an OCP S.A.F.E. pre-audit of the AST2600 BMC chip firmware.
*   Week 2: Contact Director Hsiang-Chun Wu. Present a gap analysis of the AST2600 security architecture under upcoming CRA Class II requirements.
*   Week 3: Discuss joint reference design validation with partner Sigurd Microelectronics.

#### Proposed Service Packages

| Service Package | Scope | Price (CAD) | Timeline |
|:-|:-|:-|:-|
| **AST2600 Firmware Secure Code Audit** | Secure code review and threat model of the AST2600 BMC SoC firmware and SDK | $125,000 | 6 weeks |
| **OCP S.A.F.E. Chip Pre-Audit** | Verify AST2600 hardware and cryptographic bootloaders against OCP secure hardware standards | $95,000 | 4 weeks |
| **CRA Class II Product Compliance Prep** | Audit ASPEED's SoC designs and firmware lines under Cyber Resilience Act Class II gates | $110,000 | 5 weeks |

:-

### 6.4 Sources & Citations
1.  ASPEED Technology Inc. (信驊科技股份有限公司). (2025). *Consolidated Financial Statements & Annual Report 2024*.
...
:-
*END OF PROFILE - ASPEED TECHNOLOGY - 6 PAGES*
