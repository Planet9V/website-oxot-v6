...
## TXOne Networks Inc. -  Prospect Research Dossier
...
| Field | Data | Source |
|---|---|---|
| **Full Legal Name** | TXOne Networks Inc. | Corporate registry |
| **Legal Form** | Publicly traded or private corporation | SEC filing / Exchange registry |
| **Headquarters Address** | Irving, Texas, USA | Corporate registry |
| **Founded** | 2019 | History registry |
| **President & CEO** | Terence Liu | Corporate profile |
| **Employees (Global)** | 264 | Annual report (FY2025) |
| **Website** | https://www.txone.com | - |
| **Product Security** | https://www.txone.com/psirt/ | Verified search |

### 1.2 Financial Performance (FY2023-FY2025)

| Metric | FY2025 | FY2024 | FY2023 |
|---|---|---|---|
| **Total Revenue** | $36M | $27M | $20M |
| **Year-over-Year Growth** | +35.0% | - | - |
| **EBITDA Margin** | 8.5% | - | - |
...
TXOne Networks Inc. operates through major regional and product divisions, focusing on data center infrastructure and industrial controls. It has institutional and regional ownership with sales globally.
...
|---|---|---|---|---|
| **EdgeIPS** | EdgeIPS 103, EdgeIPS Pro 216 | IP Network | Industrial IPS appliance | Compact DIN-rail |
| **Stellar** | Stellar Endpoint Protection | Endpoint | ICS endpoint agent | Lightweight brownfield |
| **Portable Inspector** | Portable Inspector USB | USB drive | Agentless malware scanner | Air-gapped compatible |
...
|---|---|---|---|
| **Terence Liu** | Chief Executive Officer | Group | Taiwan |
| **YC Wu** | Chief Financial Officer | Finance | Taiwan |
| **Akihiko Omikawa** | Chairman & Board Member | Board | Japan |
| **Nasser Zayour** | VP Global Alliances & Channels | Sales | UAE |
...
*   Week 1: Contact CEO Terence Liu. Pitch a secure boot and hardware trust audit for EdgeIPS appliances.
*   Week 2: Contact VP Global Alliances Nasser Zayour. Discuss joint channel packaging for European market compliance.
*   Week 3: Connect with Chairman Akihiko Omikawa. Outline board-level risk from EU CRA Class II compliance mandates.

#### Proposed Service Packages

| Service Package | Scope | Price (CAD) | Timeline |
|---|---|---|---|
| **EdgeIPS Hardware Security Review** | Evaluate TPM and key storage security controls on EdgeIPS appliance lines | $85,000 | 4 weeks |
| **Stellar Agent Code Audit** | Secure code audit and vulnerability review for Stellar endpoint agent software | $95,000 | 5 weeks |
| **Channel Partner Compliance Readiness** | Verify secure development processes (IEC 62443-4-1) for joint channel offerings | $70,000 | 3 weeks |

---

### 6.4 Sources & Citations
1.  TXOne Networks Inc.. (2025). *Consolidated Financial Statements & Annual Report 2024*.
...
---
*END OF PROFILE - TXONE NETWORKS - 6 PAGES*
