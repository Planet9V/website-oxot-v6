...
When I conduct an IEC 62443-3-2 zone and conduit workshop, the first question is always: "what assets are in scope?" In a petrochemical facility, the answer is usually well-documented — P&IDs, loop drawings, instrument schedules. In a datacentre, the answer is often "we think the BMS is on this VLAN, but we're not sure what else is on it."
...
### 3.1 Central Facility

**Table 7.6: 3.1 Central Facility**
