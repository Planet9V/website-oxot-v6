...
**Facility Water System (FWS):** The primary loop transports heat from CDUs to the central facility (chillers, cooling towers, or dry coolers). Large-diameter carbon steel, CPVC, or PE-100 piping. Designed per standard chilled water facility practices.
