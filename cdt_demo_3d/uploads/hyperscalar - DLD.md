...
| **Impact if Unavailable** | Loss of 1 chiller: N+1 maintained; full chiller facility failure: IT thermal trip within minutes; 100% compute loss |
...
| **Impact if Unavailable** | Loss of automated environmental control, blind to energy consumption KPIs, manual facility operation required |
...
| BMS | I — Catastrophic | Mission + Safety | Yes | SIL 1 (safety functions) | Loss of automated facility control |
...
| BMS | ≥1 server active; all safety I/O responsive | Manual facility operation; safety functions degraded |
